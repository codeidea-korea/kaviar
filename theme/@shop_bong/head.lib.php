...
$is_shop_logo = file_exists($shop_logo_path) ? true : false;
$shop_logo = '<a href="'.G5_SHOP_URL.'" class="top-header-logo" alt="'.$config['cf_title'].'">';
$shop_logo .= $is_shop_logo ? '<img src="'.get_url($shop_logo_url).'" alt="'.$config['cf_title'].'">' : $tmp_shop_logo;
$shop_logo .= '</a>';
...
$shop_hdIcon_gnb_url = str_replace(G5_PATH, G5_URL, $shop_hdIcon_gnb_path);
...
$hdIcon_gnb = file_exists($shop_hdIcon_gnb_path) ? '<img src="'.get_url($shop_hdIcon_gnb_url).'">' : $_gnbOpener;
