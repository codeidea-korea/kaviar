...
<section class="mybox blue">
	<div class="formContainer label160">
		<div class="form-list">
			...
			<div class="formCon">
				<input type="checkbox"name="shop_bottom_tabs_scrollhidden" value="1" class="toggle-light" <?=$default['shop_bottom_tabs_scrollhidden']?'checked':'';?> data-class="w-90" data-on="숨김사용" data-off="사용안함">
			</div>
		</div>
		<div class="form-list">
...
<section class="mybox blue">
	<div class="mybox-title fw600">아이콘 교채</div>
