...
<div id="mb_login" class="flex column" style="min-height:calc(var(--vh) - <?=$headerSpace_height + $bottomTabMenu_height?>px);">
	<div class="tabContainer-wrap">
		<div class="tabs">
			<span class="tab <?=$_GET['tab']==1 || !$_GET['tab']?'active':''?>" data-target="#member_form">회원</span>
			<span class="tab <?=$_GET['tab']==2?'active':''?>" data-target="#non_member_form">비회원</span>
		</div>

		<div id="member_form" class="tabContainer p20 <?=$_GET['tab']==1 || !$_GET['tab']?'open':''?>">
			 <div class="mt10">
			...
			<ul class="formContainer mt30">
				<li>
					...
					<input type="text" name="mb_id" id="login_id" placeholder="아이디" required class="frm_input required w-full" maxLength="20">
				</li>
				<li>
					<div class="label">비밀번호</div>
					<input type="password" name="mb_password" id="login_pw" placeholder="비밀번호" required class="frm_input required w-full" maxLength="20">
				</li>
			</ul>
			<div class="form-btnSet column mt20">
				<button type="submit" class="_btn/mainColor/lg">로그인</button>
				<a href="./register_main.php" class="_btn/mainColor/lg/line">회원가입</a>
			</div>
		...
		<div id="non_member_form" class="tabContainer p20 <?=$_GET['tab']==2?'open':''?>">
			...
			<ul class="formContainer mt10">
				<li>
					<input type="text" name="od_id" value="<?php echo $od_id ?>" id="od_id" placeholder="주문번호" required class="frm_input required w-full" size="20">
				</li>
				<li>
					<input type="password" name="od_pwd" size="20" id="od_pwd" placeholder="비밀번호" required class="frm_input required w-full">
				</li>
			</ul>
			<div class="form-btnSet column mt20">
				<button type="submit" class="_btn:blue">확인</button>
			</div>
			</form>
