...
set_session('ss_redirect_urls', $_GET['url']);
	...
	<div class="loginContainer">
		...
		<div id="non_member_form" class="tabContainer">
			...
			<ul class="formContainer">
				<li><input type="text" name="od_id" value="<?php echo $od_id ?>" id="od_id" placeholder="주문번호" required class="frm_input w-full /lg" size="20"></li>
				<li><input type="password" name="od_pwd" size="20" id="od_pwd" placeholder="비밀번호" required class="frm_input w-full /lg"></li>
			</ul>
			...
			?>	
			<div class="mt30 tcenter flex flex-center gap20">
				<a href="./register.php" class="fs15 noto500">회원가입</a>
			</div>
			</form>
		</div>

		<?php } else { ?>
		<div id="member_form" class="tabContainer">
			<form name="flogin" action="<?php echo $login_action_url ?>" onsubmit="return flogin_submit(this);" method="post" id="flogin">
			<input type="hidden" name="url" value="<?php echo $login_url ?>">
			
			<ul class="formContainer">
				<li><input type="text" name="mb_id" id="login_id" placeholder="아이디" required class="frm_input w-full /lg" maxLength="20"></li>
				<li><input type="password" name="mb_password" id="login_pw" placeholder="비밀번호" required class="frm_input w-full /lg" maxLength="20"></li>
				<!--<li><input type="checkbox" name="auto_login" id="login_auto_login" class="selec_chk" data-class="circle" data-label="자동로그인"></li>-->
			</ul>
			<div class="mt15 flex flex-right gap20">
				<!--<a href="./register.php" class="fs15 noto400">회원가입</a>-->
				<a href="<?php echo G5_BBS_URL ?>/password_lost.php" id="" class="fs15 noto400">아이디/비밀번호 찾기</a>
				<?if($is_mobile){?> 
					<a href="<?echo G5_BBS_URL?>/nonmember_order.php" class="fs15 noto400">비회원 주문조회</a>
				<?}?>
			</div>
			<div class="form-btnSet column mt20">
				<button type="submit" class="_btn/mainColor/lg">로그인</button>
				<a href="./register_form.php" class="_btn/mainColor/line/lg">회원가입</a>
			</div>
		...
		<script>//_tabsContainer('.tabMenu .tab', '#mb_login .tabContainer');</script>
		...
		<section id="mb_login_notmb">
			...
			<div class="bg-gray p15 rounded6">
				<h2 class="fw500">비회원 구매</h2>
			...
			<div class="form-btnSet mt20 mb20">
				<a href="javascript:guest_submit(document.flogin);" class="_btn/blue btn_submit2">비회원으로 구매하기</a>
			</div>
