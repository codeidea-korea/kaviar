  ...
  var DEFAULTS = {
    ...
    template: '<div class="datepicker-container ">' 
		+ '<div class="datepicker-panel" data-view="years picker">' 
			+ '<ul class="datepicker-header">'
				+ '<li class="prev" data-view="years prev">&lsaquo;</li>' 
				+ '<li class="current" data-view="years current"></li>' 
				+ '<li class="next" data-view="years next">&rsaquo;</li>' 
			+ '</ul>' 
			+ '<ul data-view="years"></ul>' 
		+ '</div>'
		+ '<div class="datepicker-panel" data-view="months picker">' 
			+ '<ul class="datepicker-header">' 
				+ '<li class="prev" data-view="year prev">&lsaquo;</li>' 
				+ '<li class="current" data-view="year current"></li>' 
				+ '<li class="next" data-view="year next">&rsaquo;</li>' 
			+ '</ul>' 
			+ '<ul data-view="months"></ul>' 
		+ '</div>' 
		+ '<div class="datepicker-panel" data-view="days picker">' 
			+ '<ul class="datepicker-header">' 
				+ '<li class="prev" data-view="month prev">&lsaquo;</li>' 
				+ '<li class="current" data-view="month current"></li>' 
				+ '<li class="next" data-view="month next">&rsaquo;</li>' 
			+ '</ul>' 
