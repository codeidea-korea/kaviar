...
<div class="box-tabs-container">
	...
	<div class="tabs-group">
		<a href="<?=$_adm_url?>/?tab=1&pn=_shop_config_add" class="tab <?=$pn=='_shop_config_add'?'active':''?>" data-resize="1305,830">추가설정</a>		
	</div>
	<div class="tabs-group">
		<a href="<?=$_adm_url?>/?tab=1&pn=_shop_search_keyword" class="tab <?=$pn=='_shop_search_keyword'?'active':''?>" data-resize="1250,830">추천 검색어</a>		
	</div>
	<div class="tabs-group">
