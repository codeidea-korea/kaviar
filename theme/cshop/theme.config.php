...
$theme_type = 'shop'; //인태 - 관리자 - 테마설정에서 로드
...
//define("G5_IS_MOBILE", TRUE); //인태 - pc에서도 모바일사용
...
$theme_config = array(
    ...
    'ca_mobile_img_width'           => 320,     // 모바일 분류 리스트 이미지 폭
    'ca_mobile_img_height'          => 320,     // 모바일 분류 리스트 이미지 높이
    ...
    'ev_mobile_img_width'           => 320,     // 모바일 이벤트 리스트 이미지 폭
    'ev_mobile_img_height'          => 320,     // 모바일 이벤트 리스트 이미지 높이
    ...
    'ca_mobile_list_best_row'       => 5,       // 모바일 상품리스트 베스트상품 이미지 줄 수
...
// 소셜로그인
define('G5_THEME_PLUGIN_PATH', G5_PATH.'/theme_shop/buzinga/plugin');
define('G5_THEME_PLUGIN_URL',  G5_URL.'/theme_shop/hotsauce/plugin');
