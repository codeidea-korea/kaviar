...
<div id="sod_bsk">
    ...
    <div id="sod_head" class="chk_box">
        <label class="checkbox-label"><input type="checkbox" name="ct_all" value="1" id="ct_all" class="selec_chk" checked><span></span>전체 선택</label>
    ...
    <ul class="sod_list">
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            if($it_options) {
                $mod_options = '<button type="button" id="mod_opt_'.$row['it_id'].'" class="_btn/sm/line px10 mod_options">옵션/수량 수정</button>';
               // $it_name .= ;
            }
        ...
        <li class="sod_li">
            ...
            <div class="li_op_wr">
				<div class="head">
					<label class="checkbox-label"><input type="checkbox" name="ct_chk[<?php echo $i; ?>]" value="1" id="ct_chk_<?php echo $i; ?>" class="selec_chk" checked><span></span><b class="sound_only">상품선택</b></label>
					<a href="<?php echo shop_item_url($row['it_id']); ?>" class="total_img"><?php echo $image; ?></a>
					<div class="li_name">
						<a href="<?php echo shop_item_url($row['it_id']); ?>"><?php echo $row['it_name']; ?></a>
						<div class="li_mod mt8"><?php echo $mod_options; ?></div>
					</div>
				</div>
				<div class="sod_opt pl25"><?php echo $it_options; ?></div>
				<div class="li_prqty">
					<div class="divide">
