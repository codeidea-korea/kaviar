...
function aligo_sms_call($msg, $receiver,  $type, $subject=''){
	...
	/****************** 전송정보 설정시작 ****************/
	$_POST['msg'] ="테테테테테"; // 메세지 내용 : euc-kr로 치환이 가능한 문자열만 사용하실 수 있습니다. (이모지 사용불가능)
	$_POST['receiver'] = "01099060789"; // 수신번호
	$_POST['destination'] =''; // 수신인 %고객명% 치환'
	$_POST['sender'] ="01048285646"; // 발신번호
