...
if (G5_IS_MOBILE) {
    include_once(G5_MSHOP_PATH.'/listhot.php');
    return;
}
if(is_file(G5_THIS_PATH.'/shop/listhot.php')) {
	include_once(G5_THIS_PATH.'/shop/listhot.php');
	return;
} else if(is_file(G5_THEME_SHOP_PATH.'/listhot.php')) {
	include_once(G5_THEME_SHOP_PATH.'/listhot.php');
	return;
}
...
<div id="sct">
    ...
    if (file_exists($skin_file)) {
		...
		$ca['ca_list_mod'] = $ca_id == 'all' ? 2 : $ca['ca_list_mod'];
		$ca['ca_list_row'] = $ca_id == 'all' ? 10 : $ca['ca_list_row'];
		$ca['ca_img_width'] = $ca_id == 'all' ? 230 : $ca['ca_img_width'];
		$ca['ca_img_height'] = $ca_id == 'all' ? 230 : $ca['ca_img_height'];
