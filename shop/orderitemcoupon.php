    ...
    <h3>쿠폰선택</h3>
	    ...
	    <div class="od_coupon_tbl">
	        ...
	        <tr>
	            ...
	            <td class="td_mngsmall"><button type="button" class="cp_apply _btn/mini/line">적용</button></td>
	        </tr>
	        <?php
	        }
	        ?>
	    ...
	    <div class="btn_confirm">
	        <button type="button" id="cp_close" class="btn_close"><span class="sound_only">닫기</span></button>
	    </div>
    </div>
