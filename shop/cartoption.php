...
<div class="purchaseOption-inner">	
	<div class="title">옵션/수량 수정</div>
	<button type="button" id="mod_option_close" class="btnClose"><span class="sound_only">닫기</span></button>
	<!-- 장바구니 옵션 시작 { -->
	...
	<div class="scroll-auto">
		...
		if($option_1) {
			...
			echo '<div class="sit_op_sl">'.$option_1.'</div>';
			echo '</section>';
		}
		...
		if($option_2) {
			...
			echo '<div class="sit_op_sl">'.$option_2.'</div>';
			echo '</section>';
		}
		?>
		...
		<div id="sit_sel_option">
			<ul id="sit_opt_added">
				...
				<li class="sit_opt_list">
					...
					<div class="opt_name row">
						<span class="sit_opt_subj"><?php echo $row['ct_option']; ?></span>
						<button type="button" class="sit_opt_del">삭제</button>
					</div>
					<div class="opt_count row">
	...
	<div class="purchaseOption-bottom">
		...
		<div class="sit_ov_btn">
			<button type="submit" class="_btn/lg/mainColor w-full">확인</button>
		</div>
	</div>
