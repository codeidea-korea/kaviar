...
//인태
if(file_exists(G5_THIS_SHOP_PATH.'/orderinquiry.php')) {
	require_once(G5_THIS_SHOP_PATH.'/orderinquiry.php');
	return;
}
if(file_exists(G5_THEME_SHOP_PATH.'/orderinquiry.php')) {
	require_once(G5_THEME_SHOP_PATH.'/orderinquiry.php');
	return;
}
...
<div id="sod_v">
	...
	<div id="_myContainer" class="max-width">
		...
		<div id="_myContainer_con">
			<div class="_myCon_title">주문내역

			<div class="_shop_header_searchContainer">			
				<fieldset>
					<form name="" method="get" action="./orderinquiry.php">
					<div class="inputContainer">
						<input type="text" name="search" value="<?=$search?$search:''?>" id="" maxlength="30" placeholder="주문한 상품을 검색해주세요." autocomplete='off' style="height:40px">
						<button type="submit" class="btnSubmit" value="검색" style="top:1px">검색</button>
					</div>
					</form>		
				</fieldset>
			</div>
