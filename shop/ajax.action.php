...
switch ($action) {
    ...
    case 'cart_update' : 
		...
		$chk_cart_item = sql_fetch(" select * from {$g5['g5_shop_cart_table']} where od_id = '".$tmp_cart_id."' and it_id = '".$_POST['it_id'][0]."' ");
		//echo " select * from {$g5['g5_shop_cart_table']} where where od_id = '".$tmp_cart_id."' and it_id = '".$_POST['it_id'][0]."' ";
		if($chk_cart_item['od_id']){
			// 장바구니 상품삭제
			$sql = " delete from {$g5['g5_shop_cart_table']}
						where od_id = '".$tmp_cart_id."'
						  and it_id = '".$_POST['it_id'][0]."' ";
			sql_query($sql);
		}
