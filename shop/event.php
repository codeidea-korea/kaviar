...
if(!$ev_id) {
	require_once(G5_SHOP_PATH.'/_event_main.php');
	return;
}

if(is_file(G5_THIS_SHOP_PATH.'/event.php')) {
	include_once(G5_THIS_SHOP_PATH.'/event.php');
	return;
} else if(is_file(G5_THEME_SHOP_PATH.'/event.php')) {
	include_once(G5_THEME_SHOP_PATH.'/event.php');
	return;
}
if (G5_IS_MOBILE) {
