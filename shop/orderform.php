...
//인태
if(file_exists(G5_THIS_SHOP_PATH.'/orderform.sub.php')) {
	$order_action_url = G5_THIS_SHOP_PATH.'/orderformupdate.php';
	require_once(G5_THIS_SHOP_PATH.'/orderform.sub.php');
	return;
} else if(G5_IS_MOBILE && file_exists(G5_MSHOP_PATH.'/orderform.sub.php')) {
    $order_action_url = G5_HTTPS_MSHOP_URL.'/orderformupdate.php';
    require_once(G5_MSHOP_PATH.'/orderform.sub.php');
} else {
    $order_action_url = G5_HTTPS_SHOP_URL.'/orderformupdate.php';
