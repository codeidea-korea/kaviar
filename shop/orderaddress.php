...
<div id="sod_addr" class="new_win">
    ...
    <div class="tbl_head03 tbl_wrap">
        ...
        <tr>
            <td class="td_sbj">
				<div class="flex gap5">
					<div class="chk_box">
						...
						<label class="checkbox-wrap"><input type="checkbox" name="chk[]" value="<?php echo $i;?>" id="chk_<?php echo $i;?>" class="selec_chk"><span></span></label>
            ...
            <td class="td_address">
				...
				<span class="ad_tel"><?php echo $row['ad_hp']; ?></span>
            </td>
            <td class="td_mng">
				<div class="flex column gap5">
					<input type="hidden" value="<?php echo $addr; ?>" >
					<button type="button" class="sel_address _btn/sm">선택</button>
					<a href="<?php echo $_SERVER['SCRIPT_NAME']; ?>?w=d&amp;ad_id=<?php echo $row['ad_id']; ?>" class="del_address _btn/sm/red/line">삭제</a>
					...
					<label for="ad_default<?php echo $i;?>" class="default_lb _btn/sm/blue">기본배송지</label>
				</div>
            </td>
        </tr>
    ...
    <div class="win_btn">
        <input type="submit" name="act_button" value="선택수정" class="btn_submit _btn/md/mainColor">
        <button type="button" onclick="self.close();" class="btn_close2 _btn/md/line">닫기</button>
    </div>
</div>
</form>
