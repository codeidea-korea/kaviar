...
<div id="item_view_wrap">
	...
	<section id="item_v_info">
		...
		<div class="conInfo">
				...
				if($is_closedmall) {
					...
					if($config['cf_grade'] == 1 && $mbg['g_discount'] > 0){ //할인율이 존재할경우
						if($it['it_grade']){
							...
							echo '<p class="price before">'.display_price($it['it_price']).'</p>';
							echo '<div class="flex flex-middle gap10">';
								echo '<span class="rate">'.get_discount_rate(get_price($it), $it['it_price']).'</span>';
								echo '<span class="price">'.display_price(get_price($it)).'</span>';
								echo '<input type="hidden" id="it_price" value="'.get_price($it).'">';
							echo '</div>';
							...
							echo '<p class="price before">'.display_price($it['it_cust_price']).'</p>';
							echo '<div class="flex flex-middle gap10">';
								echo '<span class="rate">'.get_discount_rate(get_price($it), $it['it_cust_price']).'</span>';
								echo '<span class="price">'.display_price(get_price($it)).'</span>';
								echo '<input type="hidden" id="it_price" value="'.get_price($it).'">';
							echo '</div>';
						}
						...
						if($it['it_cust_price']){
							...
							if($discount_rate) echo '<p class="price before">'.display_price($it['it_price']).'</p>';
							echo '<div class="flex flex-middle gap10">';
								if($discount_rate) echo '<span class="rate">'.get_discount_rate(get_price($it), $it['it_price']).'</span>';
								echo '<span class="price">'.display_price(get_price($it)).'</span>';
								echo '<input type="hidden" id="it_price" value="'.get_price($it).'">';
							echo '</div>';
						}
			...
			if($it['it_origin']) {
				echo '<div class="fs20 fw500 mt10">';
