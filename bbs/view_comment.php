...
//																			커스텀
// ───────────────────────────────────────────────────────────────────────────────────────
$commentSkin = $board_skin_path.'/view_comment.skin.php';
$commentSkin_pc = $board_pcskin_path.'/view_comment.skin.php';
if(file_exists($commentSkin)) {
	include_once($board_skin_path.'/view_comment.skin.php');
} else if(file_exists($commentSkin_pc)) {
	include_once($board_pcskin_path.'/view_comment.skin.php');
} else {
	include_once(G5_BBS_PATH.'/my/view_comment.skin.php');
}
// ───────────────────────────────────────────────────────────────────────────────────────
