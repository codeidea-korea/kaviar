        ...
        while ($row2 = sql_fetch_array($result2))
        {
            ...
            $sql = " insert into $move_write_table
                        set wr_num = '$next_wr_num',
							 ...
							 wr_use = '{$row2['wr_use']}',
							 wr_order = '{$row2['wr_order']}',
							 wr_subject_hide = '{$row2['wr_subject_hide']}',
							 wr_short_con = '".addslashes($row2['wr_short_con'])."',
							 wr_content_mobile = '".addslashes($row2['wr_content_mobile'])."',
							 wr_tag = '".addslashes($row2['wr_tag'])."',
							 wr_link_target = '{$row2['wr_link_target']}',						 
							 wr_link_name = '{$row2['wr_link_name']}',
							 wr_link_option = '{$row2['wr_link_option']}',
							 wr_video = '{$row2['wr_video']}',
							 wr_video_src = '{$row2['wr_video_src']}',
							 wr_video_play = '{$row2['wr_video_play']}',
							 wr_btn1 = '{$row2['wr_btn1']}',
							 wr_btn1_color = '{$row2['wr_btn1_color']}',
							 wr_btn2 = '{$row2['wr_btn2']}',
							 wr_btn2_color = '{$row2['wr_btn2_color']}',
							 wr_btn3 = '{$row2['wr_btn3']}',
							 wr_btn3_color = '{$row2['wr_btn3_color']}',
							 wr_btn4 = '{$row2['wr_btn4']}',
							 wr_btn4_color = '{$row2['wr_btn4_color']}',
							 wr_btn5 = '{$row2['wr_btn5']}',
							 wr_btn5_color = '{$row2['wr_btn5_color']}',
							 wr_btn6 = '{$row2['wr_btn6']}',
							 wr_btn6_color = '{$row2['wr_btn6_color']}',
