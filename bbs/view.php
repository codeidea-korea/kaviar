...
//인태 - 모바일에서 모바일 별도 내용이 없으면 pc용 내용이 출력
$view['wr_content'] = G5_IS_MOBILE && $view['wr_content_mobile'] && $view['wr_content_mobile'] != '&nbsp;' ? $view['wr_content_mobile'] : $view['wr_content'];
...
include_once(G5_BBS_PATH.'/my/_view.php');