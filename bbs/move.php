...
add_stylesheet('<link rel="stylesheet" href="'.get_url(G5_CSS_URL.'/_myform.css').'">', 2);
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            <th scope="col">
                ...
                <label for="chkall" class="checkbox-wrap"><input type="checkbox" id="chkall" onclick="if (this.checked) all_checked(true); else all_checked(false);"><span></span></label>
            </th>
            <th scope="col">게시판</th>
        </tr>
        </thead>
        ...
        <tr class="<?php echo $atc_bg; ?>">
            <td class="td_chk">
                <label for="chk<?php echo $i ?>" class="checkbox-wrap"><input type="checkbox" value="<?php echo $list[$i]['bo_table'] ?>" id="chk<?php echo $i ?>" name="chk_bo_table[]"><span></span></label>
            </td>
            <td>
