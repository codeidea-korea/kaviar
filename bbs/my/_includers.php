...
$includers = true;
?>
<div id="_includersContainer">
<style>
#_includersContainer{position:fixed;top:15px;left:0;z-index:89;}
#_includersContainer .opener{position:absolute;top:0;right:-23px;width:24px;height:24px;background:#000;display:inline-flex;align-items:center;justify-content:center;border-top-right-radius:3px;border-bottom-right-radius:3px;cursor:pointer;}
...
<?php if($includers) {
    ...
    echo '<ul class="includers" style="display:flex;flex-direction:column;gap:8px;font-family:\'Noto Sans KR\', sans-serif;font-size:12px;line-height:1em;padding:30px;background:#fafafa;max-height:calc(100vh - 60px);overflow-y:auto;">';
