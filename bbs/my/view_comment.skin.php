...
<section id="bo_view_comment">
	...
	<div class="cmCount"><span class="num"><?php echo number_format($view['wr_comment']) ?></span></div>
	...
	<?php include(G5_BBS_PATH.'/my/view_comment_form.php'); ?>
	...
	<article id="c_<?php echo $comment_id ?>" class="listCo <?=$article_re?>" style="<?php if($cmt_depth) echo 'margin-left:'.$cmt_depth.'px;';?>">
		...
		<div class="replyCon-wrap">
			<span class="replyCon"><?=$comment?></span>
