...
<form name="_adm_form" method="post" action="<?=$_adm_update_url?>/_shop_config_add_update.php" onsubmit="return _adm_form_submit(this);" autocomplete="off" enctype="multipart/form-data">
