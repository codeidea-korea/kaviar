...
$bn_bimg2_del = (isset($_POST['bn_bimg2_del']) && $_POST['bn_bimg2_del']) ? preg_replace('/[^0-9]/', '', $_POST['bn_id']) : 0;
...
$bn_location = isset($_POST['bn_location']) ? clean_xss_tags($_POST['bn_location'], 1, 1) : '';
