...
echo '<div id="_includersContainer">';
$includers = true;
if($includers) {
    $head_list = array(
	...
	$notlist = array(
         "/data/", "/_common.php", "/common.php", "adminSet.php", "_head.php", "_tail.php", "tail.php", "version.php", "/bbs/visit_insert.inc.php", "/bbs/db_table.optimize.php"
	...
	echo '<div class="opener"></div>';
    echo '<ul class="includers" style="display:flex;flex-direction:column;gap:8px;font-family:\'Noto Sans KR\', sans-serif;font-size:12px;line-height:1em;padding:30px;background:rgba(0,0,0,0.02);max-height:100%;overflow-y:auto;">';

	if($is_admin) echo '<a href="'.G5_ADMIN_URL.'/config_form.php" class="btnSetting _blank" target="_blank" style="position:absolute;top:10px;right:10px;" data-area=".includers">이벤트 관리</a>';
...
<script>
$('#_includersContainer .opener').click(function() {
	$('#_includersContainer').toggleClass('open');
});
