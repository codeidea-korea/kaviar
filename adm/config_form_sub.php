...
if(file_exists($_my_php)) {  //인태 - 커스텀 페이지로 대체
...
<section id="anc_cf_article_mail" class="mybox">
...
<section id="anc_cf_join_mail" class="mybox">
...
<section id="anc_cf_vote_mail" class="mybox">
...
<section id="anc_cf_lay" class="mybox">
...
<section id="anc_cf_sms" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr class="icode_json_version">
            ...
            <td>
                <?php echo help("알리고 토큰키를 입력시 실행됩니다.<br>SMS 전송유형을 LMS로 설정시 90바이트 이내는 SMS, 90 ~ 2000 바이트는 LMS 그 이상은 절삭 되어 LMS로 발송됩니다."); ?>
...
<section id="anc_cf_extra" class="mybox">
