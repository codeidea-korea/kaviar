...
// 회원가입 인증코드 관련 추가
$cf_join_code = implode("|", $_POST['cf_join_code']);
$cf_join_level = implode("|", $_POST['cf_join_level']);
...
//인태 - 추가
$sql .= ", cf_admin_add = '{$cf_admin_add}',
			 cf_join_captcha = '{$_POST['cf_join_captcha']}',
			 cf_password_captcha = '{$_POST['cf_password_captcha']}',
			 cf_use_login = '{$_POST['cf_use_login']}',
			 cf_use_login_popup = '{$_POST['cf_use_login_popup']}',
			 cf_use_join = '{$_POST['cf_use_join']}',
			 cf_kakao_app_key = '{$_POST['cf_kakao_app_key']}',
			 cf_use_nickname = '{$_POST['cf_use_nickname']}',
			 cf_use_sns = '{$_POST['cf_use_sns']}',
			 cf_use_join_code = '{$_POST['cf_use_join_code']}',
			 cf_join_code = '{$cf_join_code}',
			 cf_join_level = '{$cf_join_level}',
			 cf_use_stipulation = '{$_POST['cf_use_stipulation']}',
			 cf_url_random = '{$_POST['cf_url_random']}',
			 cf_show_include_admin = '{$_POST['cf_show_include_admin']}',
			 cf_use_membercode = '{$_POST['cf_use_membercode']}',
			 cf_req_membercode = '{$_POST['cf_req_membercode']}',
			 cf_stipulation_label = '{$_POST['cf_stipulation_label']}',
			 cf_privacy_label = '{$_POST['cf_privacy_label']}',
			 cf_terms_label = '{$_POST['cf_terms_label']}',
			 cf_terms = '{$_POST['cf_terms']}',
			 cf_use_ioslogin = '{$_POST['cf_use_ioslogin']}',
			 cf_ios_version = '{$_POST['cf_ios_version']}' ";
...
goto_url(G5_ADMIN_URL.'/config_form.php', false);