...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        $s_upd = '<a href="./boardgroup_form.php?'.$qstr.'&amp;w=u&amp;gr_id='.$row['gr_id'].'" class="btn_03 btn" target="_blink" rel="noreferrer noopener">수정</a>';

        $bg = 'bg'.($i%2);
    ?>

    <tr style="<?php if($row['gr_1']) echo 'background:'.$row['gr_1']; ?>">
        <td class="td_chk">
		...
		<td>
			<input type="hidden" name="gr_1[<?=$i?>]" value="<?=$row['gr_1'] ?>" class="colorpicker" data-format="rgb" data-opacity="1" data-swatches="#292929|rgba(71,78,103,0.6)|#ff4848|#1bc8a6|#1eb26e|#4880ff|#6f48ff|#fff8cf" placeholder="#">
        </td>
        ...
        <td class="">
            ...
            <select name="gr_device[<?php echo $i ?>]" id="gr_device_<?php echo $i ?>" class="span">
