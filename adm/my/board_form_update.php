...
// 빈폴더 검사후 삭제 - 인태
$board_html_path = G5_HTML_PATH.'/'.$bo_table;
if(is_empty_dir($board_html_path)) {
	rmdir($board_html_path);
}
...
// 인태 - 추가 ────────────────────────────────────────────────────────────────────────────
$bo_upload_size						=	isset($_POST['bo_upload_size']) ? $_POST['bo_upload_size'] * 1048576 : 1; //인태 - mb를 bytes로 변환해서 저장
$bo_subject_hide					=  isset($_POST['bo_subject_hide']) ? $_POST['bo_subject_hide'] : 0;
$bo_min_width						=  isset($_POST['bo_min_width']) ? $_POST['bo_min_width'] : '';
$bo_view_width						=  isset($_POST['bo_view_width']) ? $_POST['bo_view_width'] : '';
$bo_padding_top					=  isset($_POST['bo_padding_top']) ? $_POST['bo_padding_top'] : 100;
$bo_padding_bottom				=  isset($_POST['bo_padding_bottom']) ? $_POST['bo_padding_bottom'] : 100;
$bo_padding_left_right			=  isset($_POST['bo_padding_left_right']) ? $_POST['bo_padding_left_right'] : 100;
$bo_mobile_padding				=  isset($_POST['bo_mobile_padding']) ? $_POST['bo_mobile_padding'] : 15;
$bo_background						=  isset($_POST['bo_background']) ? implode("|",$_POST['bo_background']) : '';
$bo_hit									=  isset($_POST['bo_hit']) ? $_POST['bo_hit'] : 0;
$bo_btn_write_name				=  isset($_POST['bo_btn_write_name']) ? $_POST['bo_btn_write_name'] : '';
$bo_category_label				=  isset($_POST['bo_category_label']) ? $_POST['bo_category_label'] : '분류';
$bo_cate_all_hidden				=  isset($_POST['bo_cate_all_hidden']) ? $_POST['bo_cate_all_hidden'] : 0;
$bo_cate_skin						=  isset($_POST['bo_cate_skin']) ? $_POST['bo_cate_skin'] : '';
$bo_cate_color						=  isset($_POST['bo_cate_color']) ? $_POST['bo_cate_color'] : '';
$bo_tag_list							=  isset($_POST['bo_tag_list']) ? $_POST['bo_tag_list'] : '';
$bo_use_tag							=  isset($_POST['bo_use_tag']) ? $_POST['bo_use_tag'] : 0;
$bo_list_writer						=  isset($_POST['bo_list_writer']) ? $_POST['bo_list_writer'] : 0;
$bo_list_date							=  isset($_POST['bo_list_date']) ? $_POST['bo_list_date'] : 0;
$bo_search_skin					=  isset($_POST['bo_search_skin']) ? $_POST['bo_search_skin'] : '';
$bo_search_color					=  isset($_POST['bo_search_color']) ? $_POST['bo_search_color'] : '';
$bo_search_sfl						=  isset($_POST['bo_search_sfl']) ? $_POST['bo_search_sfl'] : '';
$bo_gall_mobile_cols				=  isset($_POST['bo_gall_mobile_cols']) ? $_POST['bo_gall_mobile_cols'] : 1;
$bo_max_screen					=  isset($_POST['bo_max_screen']) ? $_POST['bo_max_screen'] : '';
$bo_gall_itemspace				=  isset($_POST['bo_gall_itemspace']) ? $_POST['bo_gall_itemspace'] : 60;
$bo_gall_mobile_itemspace		=  isset($_POST['bo_gall_mobile_itemspace']) ? $_POST['bo_gall_mobile_itemspace'] : 15;
$bo_view_thumb					=  isset($_POST['bo_view_thumb']) ? $_POST['bo_view_thumb'] : 0;
$bo_view_writer						=  isset($_POST['bo_view_writer']) ? $_POST['bo_view_writer'] : 0;
$bo_view_date						=  isset($_POST['bo_view_date']) ? $_POST['bo_view_date'] : 0;
$bo_layer_popup					=  isset($_POST['bo_layer_popup']) ? $_POST['bo_layer_popup'] : 0;
$bo_popup_padding				=  isset($_POST['bo_popup_padding']) ? $_POST['bo_popup_padding'] : 0;
$bo_popup_min_size				=  isset($_POST['bo_popup_min_size']) ? $_POST['bo_popup_min_size'] : 0;
$bo_popup_max_size				=  isset($_POST['bo_popup_max_size']) ? $_POST['bo_popup_max_size'] : 0;
$bo_editor_height					=  isset($_POST['bo_editor_height']) ? $_POST['bo_editor_height'] : 0;
$bo_use_html_tag					=  isset($_POST['bo_use_html_tag']) ? $_POST['bo_use_html_tag'] : 0;
$bo_use_good_guest				=  isset($_POST['bo_use_good_guest']) ? $_POST['bo_use_good_guest'] : 0;
$bo_top_img_type					=  isset($_POST['bo_top_img_type']) ? $_POST['bo_top_img_type'] : 0;
$bo_top_img_height				=  isset($_POST['bo_top_img_height']) ? $_POST['bo_top_img_height'] : 0;
$bo_top_img_height_mob		=  isset($_POST['bo_top_img_height_mob']) ? $_POST['bo_top_img_height_mob'] : 0;
$bo_option								=  isset($_POST['bo_option']) ? $_POST['bo_option'] : '';
...
// 인태 - 추가된 칼럼 ────────────────────────────────────────────────────────────────────────────
$sql_common .= ", bo_subject_hide			= '{$bo_subject_hide}',
					 bo_min_width					= '{$bo_min_width}',
					 bo_view_width					= '{$bo_view_width}',
					 bo_padding_top					= '{$bo_padding_top}',
					 bo_padding_bottom			= '{$bo_padding_bottom}',
					 bo_padding_left_right		= '{$bo_padding_left_right}',
					 bo_mobile_padding			= '{$bo_mobile_padding}',
					 bo_background					= '{$bo_background}',
					 bo_hit								= '{$bo_hit}',
					 bo_use_good_guest			= '{$bo_use_good_guest}',
					 bo_btn_write_name			= '{$bo_btn_write_name}',
					 bo_use_mobile_write			= '{$bo_use_mobile_write}',
					 bo_category_label				= '{$bo_category_label}',
					 bo_cate_all_hidden			= '{$bo_cate_all_hidden}',
					 bo_cate_skin						= '{$bo_cate_skin}',
					 bo_cate_color					= '{$bo_cate_color}',
					 bo_tag_list						= '{$bo_tag_list}',
					 bo_use_tag						= '{$bo_use_tag}',					 
					 bo_list_writer					= '{$bo_list_writer}',
					 bo_list_date						= '{$bo_list_date}',
					 bo_search_skin					= '{$bo_search_skin}',
					 bo_search_color				= '{$bo_search_color}',
					 bo_search_sfl					= '{$bo_search_sfl}',					 
					 bo_gall_mobile_cols			= '{$bo_gall_mobile_cols}',
					 bo_max_screen					= '{$bo_max_screen}',
					 bo_gall_itemspace				= '{$bo_gall_itemspace}',
					 bo_gall_mobile_itemspace	= '{$bo_gall_mobile_itemspace}',
					 bo_view_thumb					= '{$bo_view_thumb}',
					 bo_view_writer					= '{$bo_view_writer}',
					 bo_view_date					= '{$bo_view_date}',
					 bo_layer_popup				= '{$bo_layer_popup}',
					 bo_popup_padding			= '{$bo_popup_padding}',
					 bo_popup_min_size			= '{$bo_popup_min_size}',
					 bo_popup_max_size			= '{$bo_popup_max_size}',
					 bo_editor_height				= '{$bo_editor_height}',
					 bo_use_html_tag				= '{$bo_use_html_tag}',		 			 
					 bo_top_img_type				= '{$bo_top_img_type}',
					 bo_top_img_height			= '{$bo_top_img_height}',
					 bo_top_img_height_mob	= '{$bo_top_img_height_mob}',
					 bo_option							= '{$bo_option}' ";
// ───────────────────────────────────────────────────────────────────────────────────
...
if (is_checked('chk_grp_table_width')) {
    ...
    $grp_fields .= " , bo_min_width = '{$bo_min_width}' ";
	$grp_fields .= " , bo_view_width = '{$bo_view_width}' ";
}
if (is_checked('chk_grp_padding')) {
    $grp_fields .= " , bo_padding_top = '{$bo_padding_top}' ";
    $grp_fields .= " , bo_padding_bottom = '{$bo_padding_bottom}' ";
	$grp_fields .= " , bo_padding_left_right = '{$bo_padding_left_right}' ";
	$grp_fields .= " , bo_mobile_padding = '{$bo_mobile_padding}' ";
}
if (is_checked('chk_grp_background')) {
    $grp_fields .= " , bo_background = '{$bo_background}' ";
}
// ────────────────────────────────────────────
...
if (is_checked('chk_all_table_width')) {
    ...
    $all_fields .= " , bo_min_width = '{$bo_min_width}' ";
	$all_fields .= " , bo_view_width = '{$bo_view_width}' ";
}
if (is_checked('chk_all_padding')) {
    $all_fields .= " , bo_padding_top = '{$bo_padding_top}' ";
    $all_fields .= " , bo_padding_bottom = '{$bo_padding_bottom}' ";
	$all_fields .= " , bo_padding_left_right = '{$bo_padding_left_right}' ";
	$all_fields .= " , bo_mobile_padding = '{$bo_mobile_padding}' ";
}
if (is_checked('chk_all_background')) {
    $all_fields .= " , bo_background = '{$bo_background}' ";
}
// ────────────────────────────────────────────
...
goto_url(G5_ADMIN_URL."/board_form.php?w=u&bo_table={$bo_table}&amp;{$qstr}");