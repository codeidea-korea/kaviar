...
// 인태 - 추가된 필드 ──────────────────────────────────────────
$sql .= ", bo_subject_hide				= '{$board['bo_subject_hide']}',
			 bo_min_width					= '{$board['bo_min_width']}',
			 bo_view_width					= '{$board['bo_view_width']}',
			 bo_padding_top					= '{$board['bo_padding_top']}',
			 bo_padding_bottom			= '{$board['bo_padding_bottom']}',
			 bo_padding_left_right		= '{$board['bo_padding_left_right']}',
			 bo_mobile_padding			= '{$board['bo_mobile_padding']}',
			 bo_background					= '{$board['bo_background']}',
			 bo_hit								= '{$board['bo_hit']}',
			 bo_use_good_guest			= '{$board['bo_use_good_guest']}',
			 bo_btn_write_name			= '{$board['bo_btn_write_name']}',
			 bo_use_mobile_write			= '{$board['bo_use_mobile_write']}',
			 bo_category_label				= '{$board['bo_category_label']}',
			 bo_cate_all_hidden			= '{$board['bo_cate_all_hidden']}',
			 bo_cate_skin						= '{$board['bo_cate_skin']}',
			 bo_cate_color					= '{$board['bo_cate_color']}',
			 bo_tag_list						= '{$board['bo_tag_list']}',
			 bo_use_tag						= '{$board['bo_use_tag']}',					 
			 bo_list_writer					= '{$board['bo_list_writer']}',
			 bo_list_date						= '{$board['bo_list_date']}',
			 bo_search_skin					= '{$board['bo_search_skin']}',
			 bo_search_color				= '{$board['bo_search_color']}',
			 bo_search_sfl					= '{$board['bo_search_sfl']}',					 
			 bo_gall_mobile_cols			= '{$board['bo_gall_mobile_cols']}',
			 bo_max_screen					= '{$board['bo_max_screen']}',
			 bo_gall_itemspace				= '{$board['bo_gall_itemspace']}',
			 bo_gall_mobile_itemspace	= '{$board['bo_gall_mobile_itemspace']}',
			 bo_view_thumb					= '{$board['bo_view_thumb']}',
			 bo_view_writer					= '{$board['bo_view_writer']}',
			 bo_view_date					= '{$board['bo_view_date']}',
			 bo_layer_popup				= '{$board['bo_layer_popup']}',
			 bo_popup_padding			= '{$board['bo_popup_padding']}',
			 bo_popup_min_size			= '{$board['bo_popup_min_size']}',
			 bo_popup_max_size			= '{$board['bo_popup_max_size']}',
			 bo_editor_height				= '{$board['bo_editor_height']}',
			 bo_use_html_tag				= '{$board['bo_use_html_tag']}',		 			 
			 bo_top_img_type				= '{$board['bo_top_img_type']}',
			 bo_top_img_height			= '{$board['bo_top_img_height']}',
			 bo_top_img_height_mob	= '{$board['bo_top_img_height_mob']}',
			 bo_option							= '{$board['bo_option']}' ";
...
if ($copy_case == 'schema_data_both') {
	...
	$bo_table_html_path = G5_PATH.'/html/'.$bo_table;
	$target_html_path = G5_PATH.'/html/'.$target_table;
	if(is_dir($bo_table_html_path)) {
		recursive_copy($bo_table_html_path, $target_html_path);
	}
}
// ───────────────────────────────────────────────────────────────
