...
$menu['menu300'] = array (
	...
	array('300900', '[게시판 기본 스타일]', ''.G5_ADMIN_URL.'/my/board_style.php', 'board_style', 2),
	array('300930', '[테스트용 콘텐츠 관리]', ''.G5_ADMIN_URL.'/my/tmpCon.php', 'tmpCon'),
	//array('300950', '날짜&조회수 관리', ''.G5_ADMIN_URL.'/board_manage_etc_list.php', 'board', 1),
);