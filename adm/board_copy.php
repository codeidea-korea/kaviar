    ...
    <div class=" new_win_con">
        <div class="tbl_frm01 tbl_wrap">
            ...
            <tr>
                ...
                <td><span style="color:rgba(71,78,103,0.85);"><?php echo $bo_table ?></span></td>
            </tr>
            <tr>
                <th scope="col"><label for="target_table">복사 테이블명<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="target_table" id="target_table" required class="required alnum_ span200" maxlength="20"><span class="help-block ml15">영문자, 숫자, _ 만 가능 (공백없이)</span></td>
            </tr>
            <tr>
                <th scope="col"><label for="target_subject">게시판 제목<strong class="sound_only">필수</strong></label></th>
                <td><input type="text" name="target_subject" value="[복사본] <?php echo get_sanitize_input($board['bo_subject']); ?>" id="target_subject" required class="required span200" maxlength="120"></td>
            </tr>
            <tr>
                <th scope="col">복사 유형</th>
                <td>
                    <input type="radio" name="copy_case" value="schema_only" id="copy_case" checked data-label="구조만">
                    <input type="radio" name="copy_case" value="schema_data_both" id="copy_case2" data-label="구조와 데이터" data-class="ml20">
                </td>
            </tr>
            </tbody>
            </table>
