...
$menu['menu200'] = array (
	...
	array('200150', '회원등급관리', G5_ADMIN_URL.'/member_grade_list.php', 'grade_list'),
    array('200300', '회원메일발송', G5_ADMIN_URL.'/mail_list.php', 'mb_mail'),
    array('200800', '접속자집계', G5_ADMIN_URL.'/visit_list.php?type=1', 'mb_visit', 1),
    ...
    array('200200', '포인트관리'.($config['cf_use_point']?'':' <span class="color-gray">(사용안함)</span>'), G5_ADMIN_URL.'/point_list.php', 'mb_point'),
