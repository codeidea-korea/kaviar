...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        ...
        <td>
           ...
           <select name="cz_type" id="cz_type">
				...
				<option value="2"<?php echo get_selected('2', $cp['cz_type']); ?>>시리얼쿠폰</option>
           </select>
        </td>
    </tr>
    <tr>
	...
	<tr id="tr_cz_code">
        <th scope="row"><label for="cz_code">쿠폰코드(시리얼)</label></th>
        <td>
            <input type="text" name="cz_code" value="<?php echo get_text($cp['cz_code']); ?>" id="cz_code" class="frm_input">
        </td>
    </tr>
	<tr id="tr_cz_qty">
        <th scope="row"><label for="cz_qty">쿠폰수량</label></th>
        <td>
            <input type="number" name="cz_qty" value="<?php echo get_text($cp['cz_qty']); ?>" id="cz_qty" class="frm_input">
        </td>
    </tr>
    <tr>
...
$(function() {
    ...
    $("#cz_type").change(function() {
        if($(this).val() == "1") {
            ...
            $("#tr_cz_point").hide();
			$("#tr_cz_code").find("input").attr("required", true).addClass("required");
            $("#tr_cz_code").show();
			$("#tr_cz_qty").find("input").attr("required", true).addClass("required");
            $("#tr_cz_qty").show();
        } else {
            $("#tr_cz_point").find("input").attr("required", false).removeClass("required");
            $("#tr_cz_point").hide();
			$("#tr_cz_code").find("input").attr("required", false).removeClass("required");
            $("#tr_cz_code").hide();
			$("#tr_cz_qty").find("input").attr("required", false).removeClass("required");
            $("#tr_cz_qty").hide();
        }
    });
    ...
    $("#sch_target").click(function() {
        ...
        var opt = "left=50,top=50,width=680,height=700,scrollbars=1";
