...
if($w == "" && $default['shop_type']) {
	$it['it_type'] = 1;
}
?>

<script src="<?=get_url(G5_JS_URL.'/my/form/tagsinput/jquery.tagsinput.js')?>"></script>
<link rel="stylesheet" href="<?=get_url(G5_JS_URL.'/my/form/tagsinput/jquery.tagsinput.css')?>">
...
<section class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row"><label>상품타입</label></th>
            <td>
		...
		<tr>
            <th scope="row"><label for="it_use_show">노출유무</label></th>
            <td>
                <?php echo help("체크시 리스트에 상품이 보이지 않습니다."); ?>
                <input type="checkbox" name="it_use_show" value="1" id="it_use_show" <?php echo ($it['it_use_show']) ? "checked" : ""; ?>> 숨기기
            </td>
	...
	<script>matchOnOff('#it_type', '0', '#anc_sitfrm_sendcost', '', '');</script>
</section>

<section id="anc_sitfrm_cate" class="mybox">
...
<section id="anc_sitfrm_skin" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
		<?php if(G5_IS_MOBILE) { ?>
		<input type="hidden" name="it_skin" value="<?=$ca['it_skin']?>">
		<?php } else { ?>
        <tr>
...
<section id="anc_sitfrm_ini" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            <th scope="row"><label><?=$store_label?></label></th>
            <td colspan="2">
                <?php
				echo '<div class="flex flex-middle gap20">';
					echo '<select name="it_store_id" value="'.$it['it_store_id'].'" id="it_store_id" class="selectpicker">';
						$shop_sql = "select * from {$g5['g5_shop_store_table']} where store_use = 1 order by store_order < 0, store_order = 0, store_order, store_id ";
						$shop_result = sql_query($shop_sql);
						echo option_selected_my('',  $it['it_store_id'], "", "data-content='".$store_label." 선택'");
						for ($i=0; $row=sql_fetch_array($shop_result); $i++) {
							echo option_selected_my($row['store_id'],  $it['it_store_id'], $row['store_subject'], "data-content='".$row['store_subject']."'");
						}
					echo '</select>'.PHP_EOL;
				echo '</div>';
		...
		<tr>
            <th scope="row"><label>출고지 관리</label></th>
            <td colspan="2">
                <?php
				echo '<div class="flex flex-middle gap20">';
					echo '<select name="it_shpping_name" value="'.$it['it_shpping_name'].'" id="it_shpping_name" class="selectpicker">';
						$shop_sql = "select * from `g5_shop_shipping` order by sh_name asc";
						$shop_result = sql_query($shop_sql);
						echo option_selected_my('',  $it['it_shpping_name'], "", "data-content='출고지 선택'");
						for ($i=0; $row=sql_fetch_array($shop_result); $i++) {
							echo option_selected_my($row['sh_id'],  $it['it_shpping_name'], $row['sh_name'], "data-content='".$row['sh_name']."'");
						}
					echo '</select>'.PHP_EOL;
				echo '</div>';
				//if($is_admin) echo '<a href="'.G5_ADMIN_URL.'/shop_admin/my/storelist.php" class="_btn/mainColor rd5 ml10" target="_blank">'.$store_label.' 관리</a>';
		...
		<tr>
            <th scope="row"><label>상품 이미지</label></th>
            <td colspan="2">				
		...
		<tr>
            <th scope="row">상품 태그</th>
            <td colspan="3">
                <input type="text" name="it_tag" value="<?=$it['it_tag']?>" id="it_tag" class="w-full tagInput" placeholder="태그입력 (,)로 구분">
            </td>
			<script>$(".tagInput").tagsInput();</script>
        </tr>		
        ...
        <tr>
            ...
            <td>
				<?php echo help("상품 기본정보에 모델이 노출합니다. (체크시에만 적용됩니다.)"); ?>
                <input type="checkbox" name="it_model_show" value="1" id="it_model_show" <?php echo ($it['it_model_show']) ? "checked" : ""; ?>> 노출함
        ...
        <tr>
            ...
            <td>
                <?php echo help("상품 금액 대신 입력한 텍스트로 표시됩니다. (체크시에만 적용됩니다.)"); //help("상품 금액 대신 전화문의로 표시됩니다. (체크 시에만 적용됩니다.)"); ?>
                <input type="checkbox" name="it_tel_inq" value="1" id="it_tel_inq" <?php echo ($it['it_tel_inq']) ? "checked" : ""; ?>> 예
				&nbsp;<input type="text" name="it_tel_inq_text" value="<?php echo get_text($it['it_tel_inq_text']); ?>" id="it_tel_inq_text" class="frm_input" size="40">
            </td>
            <td class="td_grpset">
		...
		<tr>
            <th scope="row"><label for="it_use">판매 시작 종료일</label></th>
            <td>
			
			<div style="display: flex;">
				<div style="display: flex;align-content: flex-start;flex-direction: column;flex-wrap: wrap;">
					<input type="text" class="form-control" name="it_sale_start_date" id="datetimepicker1" Placeholder="판매 시작일" value="<?php echo $it['it_sale_start_date']; ?>">
					<button type="button" class="btn btn-danger" id="clearDate1" style="margin-left:0px;">판매시작일 시간삭제</button>
				</div>
				&nbsp;&nbsp; ~ &nbsp;&nbsp;
				<div style="display: flex;align-content: flex-start;flex-direction: column;flex-wrap: wrap;">
					<input type="text" class="form-control" name="it_sale_end_date" id="datetimepicker2" Placeholder="판매 종료일" value="<?php echo $it['it_sale_end_date']; ?>">
					<button type="button" class="btn btn-danger" id="clearDate2" style="margin-left:0px;">판매종료일 시간삭제</button>
				</div>
			</div>
	...
	<!--
		<tr>
            <th scope="row"><label for="it_use">판매 시작 종료일</label></th>
            <td>
                <input type="datetime-local" name="it_sale_start_date" value="<?php echo $it['it_sale_start_date']; ?>"> ~ <input type="datetime-local" name="it_sale_end_date" value="<?php echo $it['it_sale_end_date']; ?>">
            </td>
            <td class="td_grpset">
	...
	-->
		<tr>
            <th scope="row"><label for="it_grade">회원혜택전용</label></th>
            <td>
				<div class="local_desc02 local_desc">
					<p><strong>회원혜택 적용시 회원등급관리에서 사용함으로 변경해야지 적용이됩니다.</strong></p>
				</div>
                <input type="checkbox" name="it_grade" value="1" id="it_grade" <?php echo ($it['it_grade']) ? "checked" : ""; ?>> 예
            </td>
            <td class="td_grpset">
                <input type="checkbox" name="chk_ca_it_grade" value="1" id="chk_ca_it_grade">
                <label for="chk_ca_it_grade">분류적용</label>
                <input type="checkbox" name="chk_all_it_grade" value="1" id="chk_all_it_grade">
                <label for="chk_all_it_grade">전체적용</label>
            </td>
        </tr>
        <tr>
...
<section id="anc_sitfrm_compact" class="mybox">
...
<section id="anc_sitfrm_cost" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		$startdate = $it['it_timer_start'] ? $it['it_timer_start'].':00' : '';
		...
		?>
		<tr style="<?=$is_item_timer?'background:rgba(255,58,58,0.02);':''?>">			
            <th scope="row"><label for="it_time_price">타임특가<?=$is_item_timer?' <span class="color-red">(적용중)</span>':''?></label></th>
            <td>
				...
				<label class="labelDatetime ml20">
					<span class="label">시작날짜</span>
                    <input type="text" name="it_timer_start" value="<?=$it['it_timer_start']?>" size="9" id="it_timer_start" class="w-150<?=$timediffer > 0?'':' color-slate-400'?>" placeholder="0000-00-00 00:00">
                </label>
        ...
        <tr>
            ...
            <td>
                ...
                <select name="it_point_type" id="it_point_type">
				    <option value="2"<?php echo get_selected('2', $it['it_point_type']); ?> checked>구매가기준 설정비율</option>
        ...
        <tr>
            ...
            <td>
                ...
                <label class="labelInput right-label"><input type="text" name="it_point" value="<?=$it['it_point']!=""?$it['it_point']:"5"?>" id="it_point" class="frm_input" size="8"><span id="it_point_unit" class="label">
				<?php /*if($it['it_point_type']) echo '%'; else echo '점';*/ echo '%'; ?></span></label>
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_supply_point" value="<?php echo $it['it_supply_point']; ?>" id="it_supply_point" class="frm_input" size="8" data-label-right="점">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_stock_qty" value="<?php echo $it['it_stock_qty']; ?>" id="it_stock_qty" class="frm_input" size="8" data-label-right="개">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_noti_qty" value="<?php echo $it['it_noti_qty']; ?>" id="it_noti_qty" class="frm_input" size="8" data-label-right="개">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_buy_min_qty" value="<?php echo $it['it_buy_min_qty']; ?>" id="it_buy_min_qty" class="frm_input" size="8" data-label-right="개">
            </td>
            <td class="td_grpset">
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="it_buy_max_qty" value="<?php echo $it['it_buy_max_qty']; ?>" id="it_buy_max_qty" class="frm_input" size="8" data-label-right="개">
            </td>
            <td class="td_grpset">
...
<section id="anc_sitfrm_sendcost" class="mybox">
    ...
    <div id="delivery-info" class="tbl_frm01 tbl_wrap">
        <table>
...
<section id="anc_sitfrm_relation" class="srel mybox">
...
<section id="anc_sitfrm_event" class="srel mybox">
...
<section id="anc_sitfrm_optional" class="mybox">
...
<section id="anc_sitfrm_extra" class="mybox">
    <h2 class="none">여분필드 설정</h2>
    <?php echo $pg_anchor ?>
