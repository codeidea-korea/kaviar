...
<section id="anc_scf_info" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
			...
			<th scope="row"><label for="de_admin_domain">대표도메인(http 포함)</label></th>
            <td>
                <input type="text" name="de_admin_domain"  value="<?php echo get_sanitize_input($default['de_admin_domain']); ?>" id="de_admin_domain" class="frm_input" size="30">
            </td>
        </tr>
        <tr>
...
<section id="anc_scf_skin" class="mybox">
...
<section id ="anc_scf_payment" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="cf_use_point">현금할인률</label></th>
            <td>
				<input type="checkbox" name="de_cash_sale_use" value="1" id="de_cash_sale_use"<?php echo $default['de_cash_sale_use']?' checked':''; ?>> 사용
                <input type="text" name="de_cash_sale" value="<?php echo get_sanitize_input($default['de_cash_sale']); ?>" id="de_cash_sale" class="frm_input" size="10"> %
            </td>
        </tr>
        <tr>
		...
		<tr>
            <th scope="row"><label for="de_settle_order_min_point">최소 구매금액<br>(포인트사용)</label></th>
            <td>
                <?php echo help("회원의 포인트가 설정값 이상일 경우만 주문시 결제에 사용할 수 있습니다.\n포인트 사용을 하지 않는 경우에는 의미가 없습니다."); ?>
                <input type="text" name="de_settle_order_min_point" value="<?php echo get_sanitize_input($default['de_settle_order_min_point']); ?>" id="de_settle_order_min_point" class="frm_input" size="10"> 원
            </td>
        </tr>
        <tr>
...
<section id="anc_scf_delivery" class="mybox">
    <h2 >배송설정</h2>
...
<section id="anc_scf_etc" class="mybox">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
				...
				<div class="flex gap10">
					...
					<input type="text" name="de_rel_img_width" value="<?php echo get_sanitize_input($default['de_rel_img_width']); ?>" id="de_rel_img_width" class="frm_input" size="3" data-label="이미지폭">
					<input type="text" name="de_rel_img_height" value="<?php echo get_sanitize_input($default['de_rel_img_height']); ?>" id="de_rel_img_height" class="frm_input" size="3" data-label="이미지높이">
					<input type="text" name="de_rel_list_mod" value="<?php echo get_sanitize_input($default['de_rel_list_mod']); ?>" id="de_rel_list_mod" class="frm_input" size="3" data-label="1줄당 이미지 수">
					<input type="checkbox" name="de_rel_list_use" value="1" id="de_rel_list_use" <?php echo $default['de_rel_list_use']?"checked":""; ?> data-label="출력">
				</div>
            </td>
        </tr>
        <tr>
            ...
            <td>
				...
				<div class="flex gap10">
					...
					<input type="text" name="de_mobile_rel_img_width" value="<?php echo get_sanitize_input($default['de_mobile_rel_img_width']); ?>" id="de_mobile_rel_img_width" class="frm_input" size="3" data-label="이미지폭">
					<input type="text" name="de_mobile_rel_img_height" value="<?php echo get_sanitize_input($default['de_mobile_rel_img_height']); ?>" id="de_mobile_rel_img_height" class="frm_input" size="3" data-label="이미지높이">
					<input type="text" name="de_mobile_rel_list_mod" value="<?php echo get_sanitize_input($default['de_mobile_rel_list_mod']); ?>" id="de_mobile_rel_list_mod" class="frm_input" size="3" data-label="1줄당 이미지 수">
					<input type="checkbox" name="de_mobile_rel_list_use" value="1" id="de_mobile_rel_list_use" <?php echo $default['de_mobile_rel_list_use']?"checked":""; ?> data-label="출력">
				</div>
            </td>
        </tr>
		 <tr>
            ...
            <td>
                <div class="flex gap10">
					...
					<input type="text" name="de_search_img_width" value="<?php echo get_sanitize_input($default['de_search_img_width']); ?>" id="de_search_img_width" class="frm_input" size="3" data-label="이미지폭">
					<input type="text" name="de_search_img_height" value="<?php echo get_sanitize_input($default['de_search_img_height']); ?>" id="de_search_img_height" class="frm_input" size="3" data-label="이미지높이">
					<input type="text" name="de_search_list_mod" value="<?php echo get_sanitize_input($default['de_search_list_mod']); ?>" id="de_search_list_mod" class="frm_input" size="3" data-label="1줄당 이미지 수">
					<input type="text" name="de_search_list_row" value="<?php echo get_sanitize_input($default['de_search_list_row']); ?>" id="de_search_list_row" class="frm_input" size="3" data-label="출력할 줄 수">
				</div>
            </td>
        </tr>
        <tr>
            ...
            <td>
				<div class="flex gap10">
					...
					<input type="text" name="de_mobile_search_img_width" value="<?php echo get_sanitize_input($default['de_mobile_search_img_width']); ?>" id="de_mobile_search_img_width" class="frm_input" size="3" data-label="이미지폭">
					<input type="text" name="de_mobile_search_img_height" value="<?php echo get_sanitize_input($default['de_mobile_search_img_height']); ?>" id="de_mobile_search_img_height" class="frm_input" size="3" data-label="이미지높이">
					<input type="text" name="de_mobile_search_list_mod" value="<?php echo get_sanitize_input($default['de_mobile_search_list_mod']); ?>" id="de_mobile_search_list_mod" class="frm_input" size="3" data-label="1줄당 이미지 수">
					<input type="text" name="de_mobile_search_list_row" value="<?php echo get_sanitize_input($default['de_mobile_search_list_row']); ?>" id="de_mobile_search_list_row" class="frm_input" size="3" data-label="출력할 줄 수">
				</div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="flex gap10">
					...
					<input type="text" name="de_listtype_img_width" value="<?php echo get_sanitize_input($default['de_listtype_img_width']); ?>" id="de_listtype_img_width" class="frm_input" size="3" data-label="이미지폭">
					<input type="text" name="de_listtype_img_height" value="<?php echo get_sanitize_input($default['de_listtype_img_height']); ?>" id="de_listtype_img_height" class="frm_input" size="3" data-label="이미지높이">
					<input type="text" name="de_listtype_list_mod" value="<?php echo get_sanitize_input($default['de_listtype_list_mod']); ?>" id="de_listtype_list_mod" class="frm_input" size="3" data-label="1줄당 이미지 수">
					<input type="text" name="de_listtype_list_row" value="<?php echo get_sanitize_input($default['de_listtype_list_row']); ?>" id="de_listtype_list_row" class="frm_input" size="3" data-label="출력할 줄 수">
				</div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="flex gap10">
					...
					<input type="text" name="de_mobile_listtype_img_width" value="<?php echo get_sanitize_input($default['de_mobile_listtype_img_width']); ?>" id="de_mobile_listtype_img_width" class="frm_input" size="3" data-label="이미지폭">
					<input type="text" name="de_mobile_listtype_img_height" value="<?php echo get_sanitize_input($default['de_mobile_listtype_img_height']); ?>" id="de_mobile_listtype_img_height" class="frm_input" size="3" data-label="이미지높이">
					<input type="text" name="de_mobile_listtype_list_mod" value="<?php echo get_sanitize_input($default['de_mobile_listtype_list_mod']); ?>" id="de_mobile_listtype_list_mod" class="frm_input" size="3" data-label="1줄당 이미지 수">
					<input type="text" name="de_mobile_listtype_list_row" value="<?php echo get_sanitize_input($default['de_mobile_listtype_list_row']); ?>" id="de_mobile_listtype_list_row" class="frm_input" size="3" data-label="출력할 줄 수">
				</div>
            </td>
        </tr>
        <tr>
		...
		<tr>
            <th scope="row"><label for="de_item_use_approval">사용후기 승인 후<br>포인트지급 사용유무</label></th>
            <td>
                <input type="checkbox" name="de_item_use_approval" value="1" id="de_item_use_approval"<?php echo $default['de_item_use_approval']?' checked':''; ?>> 사용
            </td>
        </tr>
		 <tr>
            <th scope="row">후기 포인트 금액설정</th>
            <td>
                일반 후기 : <input type="text" name="de_item_use_review" value="<?php echo get_sanitize_input($default['de_item_use_review']); ?>" id="de_item_use_review" class="frm_input" size="5">
				포토 후기 : <input type="text" name="de_item_use_review_p" value="<?php echo get_sanitize_input($default['de_item_use_review_p']); ?>" id="de_item_use_review_p" class="frm_input" size="5">
            </td>
        </tr>
        <tr>
		...
		<tr>
            <th scope="row"><label>상품 최상단 이미지</label></th>
            <td colspan="2">				
				<ul class="fileImgSet" style="--img-size:120px">
					...
					for($ii=1; $ii<=1; $ii++) {
						echo '<li class="img_li">';
							echo '<input type="file" name="it_img'.$ii.'" id="it_img'.$ii.'" class="myfile">';
							echo '<div class="upImg">';
							$it_img = G5_DATA_PATH.'/file/'.$default['de_item_list_top_img'];
							$it_img_url = G5_DATA_URL.'/file/'.$default['de_item_list_top_img'];
							if(is_file($it_img) && file_exists($it_img)){
								$it_img_exists = true;
							}else{
								$it_img_exists = false;
							}
							...
							if($it_img_exists) {
								$thumb = get_it_thumbnail($default['de_item_list_top_img'], $it_width, $it_height);
								echo '<img src="'.$it_img_url.'">';
							}							
							echo '</div>';
							if($it_img_exists) echo '<input type="checkbox" name="it_img'.$ii.'_del" id="it_img'.$ii.'_del" value="1" data-label="파일삭제">';
		...
		<tr>
            <th scope="row"><label for="de_popular_word">인기검색어 삭제</label></th>
            <td>
                <?php echo help("인기검색어 삭제는 매일 오전1시에 작동되며, 삭제하시고 싶은 검색어를 입력해주세요. ex) 1, 2, 3, P, A"); ?>
                <input type="text" name="de_popular_word" value="<?php echo get_sanitize_input($default['de_popular_word']); ?>" id="de_popular_word" class="frm_input" size="100">
            </td>
        </tr>
		
		<tr>
            <th scope="row"><label for="de_popular_word">인기검색어 등록</label></th>
            <td>
		<?  for($u=1; $u <= 5; $u++){	?>
                <?=$u?> : <input type="text" name="de_popular_<?=$u?>" value="<?php echo get_sanitize_input($default['de_popular_'.$u]); ?>" class="frm_input" size="10">
		<?	}?>
			<br><br>
		<?  for($t=6; $t <= 10; $t++){	?>
                <?=$t?> : <input type="text" name="de_popular_<?=$t?>" value="<?php echo get_sanitize_input($default['de_popular_'.$t]); ?>" class="frm_input" size="10">
		<?	}?>
            </td>
        </tr>
        </tbody>
...
function byte_check(el_cont, el_byte)
{
    ...
    var exceed = 0;
    var ch = '';
    /*var limit_num = (jQuery("#cf_sms_type").val() == "LMS") ? 1500 : 200;*/

	var limit_num = 2000;
/*
    if( $("input[name='cf_aligo_token_key']").length && $("input[name='cf_aligo_token_key']").val() && jQuery("#cf_sms_type").val() == "LMS" ){
        limit_num = 2000;
    }
*/
...
<!-- 2024-02-21 준섭 알리고,네이버 추가 -->

<section id="anc_scf_sms" class="mybox mt30">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr class="sms_use1">
            <th scope="row"><label for="cf_aligo_sender">알리고 발송전화번호</label></th>
            <td>
                <?php echo help("고객에게 발송되는 전화번호. 예) 0101234567"); ?>
                <input type="text" name="cf_aligo_sender" value="<?php echo get_sanitize_input($config['cf_aligo_sender']); ?>" id="cf_aligo_sender" class="frm_input" size="20">
            </td>
        </tr>
		<tr class="sms_use1">
            <th scope="row"><label for="cf_aligo_token_key">알리고 토큰키</th>
            <td>
                <input type="text" name="cf_aligo_token_key" value="<?php echo get_sanitize_input($config['cf_aligo_token_key']); ?>" id="cf_aligo_token_key" class="frm_input" size="40">
                <?php echo help("알리고 사이트 -> 토큰키관리 메뉴에서 생성한 토큰키를 입력합니다."); ?>
            </td>
        </tr>

		<tr class="sms_use2">
            <th scope="row"><label for="cf_aligo_sender">네이버 발송전화번호</label></th>
            <td>
                <?php echo help("고객에게 발송되는 전화번호. 예) 0101234567"); ?>
                <input type="text" name="cf_naver_sender" value="<?php echo get_sanitize_input($config['cf_naver_sender']); ?>" id="cf_naver_sender" class="frm_input" size="20">
            </td>
        </tr>
         </tbody>
        </table>
    ...
    <section id="scf_sms_pre">
        ...
        <div class="local_desc01 local_desc">
           ...
           <p><?php echo help('영문 한글자 : 1byte , 한글 한글자 : 2bytes , 특수문자의 경우 1 또는 2 bytes 임'); ?></p>
        </div>

        <div id="scf_sms">
            <?php
            $scf_sms_title = array (1=>"회원가입시 고객발송", "ID/PW찾기", "무통장 정보 발송", "주문완료시 고객발송", "환불완료 고객발송","반품완료 고객발송","입금완료 고객발송","상품발송 고객발송","상품질문답변", "후기승인", "배송완료시", "적립금소멸(정보성)", "입금요청", "무통장자동취소");
            for ($i=1; $i<=14; $i++) {
            ?>
            <section class="scf_sms_box">
                ...
                <span id="byte<?php echo $i; ?>" class="scf_sms_cnt">0 / 2000 바이트</span>
            </section>
...
<!-- 2024-02-21 준섭 알리고,네이버 추가 끝 -->


<?php
//쇼핑몰 초기화면 - 블럭형태로 교채하면서 사용안함
//히트상품
echo '<input type="hidden" name="de_type1_list_use" value="'.($default['de_type1_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_type1_list_skin" value="'.$default['de_type1_list_skin'].'">';
echo '<input type="hidden" name="de_type1_list_mod" value="'.$default['de_type1_list_mod'].'">';
echo '<input type="hidden" name="de_type1_list_row" value="'.$default['de_type1_list_row'].'">';
echo '<input type="hidden" name="de_type1_img_width" value="'.$default['de_type1_img_width'].'">';
echo '<input type="hidden" name="de_type1_img_height" value="'.$default['de_type1_img_height'].'">';
//추천상품
echo '<input type="hidden" name="de_type2_list_use" value="'.($default['de_type2_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_type2_list_skin" value="'.$default['de_type2_list_skin'].'">';
echo '<input type="hidden" name="de_type2_list_mod" value="'.$default['de_type2_list_mod'].'">';
echo '<input type="hidden" name="de_type2_list_row" value="'.$default['de_type2_list_row'].'">';
echo '<input type="hidden" name="de_type2_img_width" value="'.$default['de_type2_img_width'].'">';
echo '<input type="hidden" name="de_type2_img_height" value="'.$default['de_type2_img_height'].'">';
//최신상품
echo '<input type="hidden" name="de_type3_list_use" value="'.($default['de_type3_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_type3_list_skin" value="'.$default['de_type3_list_skin'].'">';
echo '<input type="hidden" name="de_type3_list_mod" value="'.$default['de_type3_list_mod'].'">';
echo '<input type="hidden" name="de_type3_list_row" value="'.$default['de_type3_list_row'].'">';
echo '<input type="hidden" name="de_type3_img_width" value="'.$default['de_type3_img_width'].'">';
echo '<input type="hidden" name="de_type3_img_height" value="'.$default['de_type3_img_height'].'">';
//인기상품
echo '<input type="hidden" name="de_type4_list_use" value="'.($default['de_type4_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_type4_list_skin" value="'.$default['de_type4_list_skin'].'">';
echo '<input type="hidden" name="de_type4_list_mod" value="'.$default['de_type4_list_mod'].'">';
echo '<input type="hidden" name="de_type4_list_row" value="'.$default['de_type4_list_row'].'">';
echo '<input type="hidden" name="de_type4_img_width" value="'.$default['de_type4_img_width'].'">';
echo '<input type="hidden" name="de_type4_img_height" value="'.$default['de_type4_img_height'].'">';
//할인상품
echo '<input type="hidden" name="de_type5_list_use" value="'.($default['de_type5_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_type5_list_skin" value="'.$default['de_type5_list_skin'].'">';
echo '<input type="hidden" name="de_type5_list_mod" value="'.$default['de_type5_list_mod'].'">';
echo '<input type="hidden" name="de_type5_list_row" value="'.$default['de_type5_list_row'].'">';
echo '<input type="hidden" name="de_type5_img_width" value="'.$default['de_type5_img_width'].'">';
echo '<input type="hidden" name="de_type5_img_height" value="'.$default['de_type5_img_height'].'">';

//히트상품(모바일)
echo '<input type="hidden" name="de_mobile_type1_list_use" value="'.($default['de_mobile_type1_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_mobile_type1_list_skin" value="'.$default['de_mobile_type1_list_skin'].'">';
echo '<input type="hidden" name="de_mobile_type1_list_mod" value="'.$default['de_mobile_type1_list_mod'].'">';
echo '<input type="hidden" name="de_mobile_type1_list_row" value="'.$default['de_mobile_type1_list_row'].'">';
echo '<input type="hidden" name="de_mobile_type1_img_width" value="'.$default['de_mobile_type1_img_width'].'">';
echo '<input type="hidden" name="de_mobile_type1_img_height" value="'.$default['de_mobile_type1_img_height'].'">';
//추천상품(모바일)
echo '<input type="hidden" name="de_mobile_type2_list_use" value="'.($default['de_mobile_type2_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_mobile_type2_list_skin" value="'.$default['de_mobile_type2_list_skin'].'">';
echo '<input type="hidden" name="de_mobile_type2_list_mod" value="'.$default['de_mobile_type2_list_mod'].'">';
echo '<input type="hidden" name="de_mobile_type2_list_row" value="'.$default['de_mobile_type2_list_row'].'">';
echo '<input type="hidden" name="de_mobile_type2_img_width" value="'.$default['de_mobile_type2_img_width'].'">';
echo '<input type="hidden" name="de_mobile_type2_img_height" value="'.$default['de_mobile_type2_img_height'].'">';
//최신상품(모바일)
echo '<input type="hidden" name="de_mobile_type3_list_use" value="'.($default['de_mobile_type3_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_mobile_type3_list_skin" value="'.$default['de_mobile_type3_list_skin'].'">';
echo '<input type="hidden" name="de_mobile_type3_list_mod" value="'.$default['de_mobile_type3_list_mod'].'">';
echo '<input type="hidden" name="de_mobile_type3_list_row" value="'.$default['de_mobile_type3_list_row'].'">';
echo '<input type="hidden" name="de_mobile_type3_img_width" value="'.$default['de_mobile_type3_img_width'].'">';
echo '<input type="hidden" name="de_mobile_type3_img_height" value="'.$default['de_mobile_type3_img_height'].'">';
//인기상품(모바일)
echo '<input type="hidden" name="de_mobile_type4_list_use" value="'.($default['de_mobile_type4_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_mobile_type4_list_skin" value="'.$default['de_mobile_type4_list_skin'].'">';
echo '<input type="hidden" name="de_mobile_type4_list_mod" value="'.$default['de_mobile_type4_list_mod'].'">';
echo '<input type="hidden" name="de_mobile_type4_list_row" value="'.$default['de_mobile_type4_list_row'].'">';
echo '<input type="hidden" name="de_mobile_type4_img_width" value="'.$default['de_mobile_type4_img_width'].'">';
echo '<input type="hidden" name="de_mobile_type4_img_height" value="'.$default['de_mobile_type4_img_height'].'">';
//할인상품(모바일)
echo '<input type="hidden" name="de_mobile_type5_list_use" value="'.($default['de_mobile_type5_list_use']?'1':'').'">';
echo '<input type="hidden" name="de_mobile_type5_list_skin" value="'.$default['de_mobile_type5_list_skin'].'">';
echo '<input type="hidden" name="de_mobile_type5_list_mod" value="'.$default['de_mobile_type5_list_mod'].'">';
echo '<input type="hidden" name="de_mobile_type5_list_row" value="'.$default['de_mobile_type5_list_row'].'">';
echo '<input type="hidden" name="de_mobile_type5_img_width" value="'.$default['de_mobile_type5_img_width'].'">';
echo '<input type="hidden" name="de_mobile_type5_img_height" value="'.$default['de_mobile_type5_img_height'].'">';
?>
