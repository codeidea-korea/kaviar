...
if(file_exists(G5_THEME_PATH.'/adm/_shop_logo_register.php')) {
	require_once(G5_THEME_PATH.'/adm/_shop_logo_register.php');
    return;
}
?>

<form name="adm_form" id="adm_form" method="post" onsubmit="return adm_form_submit(this);" autocomplete="off" action="./shop_logo_register_update.php" enctype="multipart/form-data">
<input type="hidden" name="token" value="" id="token">

<section class="mybox">
	<h2 class="mybox-title">쇼핑몰 로고 관리</h2>
