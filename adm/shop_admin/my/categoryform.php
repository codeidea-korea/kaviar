...
<section id="anc_scatefrm_basic" class="mybox blue">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label>분류 이미지</label></th>
            <td colspan="2">				
				<ul class="fileImgSet" style="--img-size:120px">
					<?php
					$ca_id_val = $w == "" ? $subid : $ca['ca_id'];
					echo '<li class="img_li">';
						echo '<input type="file" name="shop_cate_img" class="myfile">';
						echo '<div class="upImg">';
						$img_path = G5_DATA_PATH.'/shop_cate/'.$ca_id_val;
						$ca_img = "";
						
						if(is_file($img_path) && file_exists($img_path)) {
							$ca_thumb = thumbnail($ca_id_val, G5_DATA_PATH.'/shop_cate/', G5_DATA_PATH.'/shop_cate/', 180, '', 1, 1, 'center');								
							$ca_img .= '<img src="'.G5_DATA_URL.'/shop_cate/'.$ca_thumb.'?'.preg_replace('/[^0-9]/i', '', $ca['ca_time']).'">';
						}
						echo $ca_img;
						
						echo '</div>';
						if($ca_img) echo '<input type="checkbox" name="del_img" value="1">';
					echo '</li>';
					?>
				</ul>
            </td>
		...
		<?php if(G5_IS_MOBILE) { ?>
		<input type="hidden" name="ca_skin_dir" value="<?=$ca['ca_skin_dir']?>">
		<?php } else { ?>
        <tr>
		...
		<tr>
            <th scope="row">카테고리 메뉴 사용</th>
            <td>
				<input type="checkbox" name="ca_menu_use" <?php echo ($ca['ca_menu_use']) ? "checked" : ""; ?> value="1" id="ca_menu_use" data-label="사용함">
            </td>
        </tr>
        <tr>
            <th scope="row">본인확인 체크</th>
            <td>
                <input type="radio" name="ca_cert_use" value="1" id="ca_cert_use_yes" <?php if($ca['ca_cert_use']) echo 'checked="checked"'; ?> data-label="사용함">
                <input type="radio" name="ca_cert_use" value="0" id="ca_cert_use_no" <?php if(!$ca['ca_cert_use']) echo 'checked="checked"'; ?> data-label="사용안함" data-class="ml15">
            </td>
        </tr>
        <tr>
            <th scope="row">성인인증 체크</th>
            <td>
                <input type="radio" name="ca_adult_use" value="1" id="ca_adult_use_yes" <?php if($ca['ca_adult_use']) echo 'checked="checked"'; ?> data-label="사용함">
                <input type="radio" name="ca_adult_use" value="0" id="ca_adult_use_no" <?php if(!$ca['ca_adult_use']) echo 'checked="checked"'; ?> data-label="사용안함" data-class="ml15">
            </td>
        </tr>
		<?php if(G5_IS_MOBILE) { ?>
		<input type="hidden" name="ca_skin" value="<?=$ca['ca_skin']?>">
		<input type="hidden" name="ca_img_width" value="<?=$ca['ca_img_width']?>">
		<input type="hidden" name="ca_img_height" value="<?=$ca['ca_img_height']?>">
		<input type="hidden" name="ca_list_mod" value="<?=$ca['ca_list_mod']?>">
		<input type="hidden" name="ca_list_row" value="<?=$ca['ca_list_row']?>">
		<?php } else { ?>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_img_width" value="<?php echo $ca['ca_img_width']; ?>" id="ca_img_width" required class="required frm_input" size="5" data-label-inline="PX">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_img_height"  value="<?php echo $ca['ca_img_height']; ?>" id="ca_img_height" required class="required frm_input" size="5" data-label-inline="PX">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_list_mod" size="3" value="<?php echo $ca['ca_list_mod']; ?>" id="ca_list_mod" required class="required frm_input"data-label-inline="개">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_list_row" value='<?php echo $ca['ca_list_row']; ?>' id="ca_list_row" required class="required frm_input" size="3"data-label-inline="줄">
            </td>
        </tr>
		<?php } ?>
        <tr>
        ...
        <tr>
            ...
            <td>
                <?php echo help("쇼핑몰환경설정 &gt; 이미지(소) 넓이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 폭입니다."); ?>
                <input type="text" name="ca_mobile_img_width" value="<?php echo $ca['ca_mobile_img_width']; ?>" id="ca_mobile_img_width" required class="required frm_input" size="5" data-label-inline="PX">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php echo help("쇼핑몰환경설정 &gt; 이미지(소) 높이가 기본값으로 설정됩니다.\n".G5_SHOP_URL."/list.php에서 출력되는 이미지의 높이입니다."); ?>
                <input type="text" name="ca_mobile_img_height"  value="<?php echo $ca['ca_mobile_img_height']; ?>" id="ca_mobile_img_height" required class="required frm_input" size="5" data-label-inline="PX">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php echo help("한 줄에 설정한 값만큼의 상품을 출력하지만 스킨에 따라 한 줄에 하나의 상품만 출력할 수도 있습니다."); ?>
                <input type="text" name="ca_mobile_list_mod" value='<?php echo $ca['ca_mobile_list_mod']; ?>' id="ca_mobile_list_mod" required class="required frm_input" size="3" data-label-inline="개">
            </td>
        </tr>
        <tr>
            ...
            <td>
                <?php echo help("한 페이지에 출력할 이미지 줄 수를 설정합니다.\n한 페이지에서 표시하는 상품수는 (1줄당 이미지 수 x 줄 수) 입니다."); ?>
                <input type="text" name="ca_mobile_list_row" value='<?php echo $ca['ca_mobile_list_row']; ?>' id="ca_mobile_list_row" required class="required frm_input" size="3" data-label-inline="줄">
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <input type="text" name="ca_stock_qty" size="10" value="<?php echo $ca['ca_stock_qty']; ?>" id="ca_stock_qty" class="frm_input" data-label-inline="개">
            </td>
        </tr>
        <tr>
...
<section id="anc_scatefrm_optional" class="mybox blue">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<?php if(G5_IS_MOBILE) { ?>
		<input type="hidden" name="ca_head_html" value="<?=$ca['ca_head_html']?>">
		<input type="hidden" name="ca_tail_html" value="<?=$ca['ca_tail_html']?>">
		<?php } else { ?>
        <tr>
...
<section id="anc_scatefrm_extra" class="mybox blue">
    <h2>여분필드 설정</h2>
...
<?php if ($w == "u") { ?>
<section id="frm_etc" class="mybox blue">
