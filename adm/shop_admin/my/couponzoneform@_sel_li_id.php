    ...
    <tr id="tr_cp_target">
        ...
        <td>
			<div class="flex flex-middle">
				<input type="text" name="cp_target" value="<?php echo stripslashes($cp['cp_target']); ?>" id="cp_target" required class="required frm_input flex1">
...
$(function() {
    ...
    $("#sch_target").click(function() {
        ...
        var opt = "left=50,top=50,width=720,height=760,scrollbars=1";
        var url = "./coupontarget.php?sch_target=";

        if(cp_method == "0") {
			var sel_li_id = $('#cp_target').val(),
				sel_li_id = sel_li_id.replace(' ', '');
            window.open(url+"0&sel_li_id="+sel_li_id, "win_target", opt);
        } else if(cp_method == "1") {
