    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                ...
                <label class="labelInput right-label"><input type="text" name="it_point" value="<?php echo $it['it_point']; ?>" id="it_point" class="frm_input" size="8"><span id="it_point_unit" class="label"><?php if($it['it_point_type']) echo '%'; else echo '점'; ?></span></label>
            </td>
            <td class="td_grpset">
