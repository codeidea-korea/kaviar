...
<div class="tbl_head01 tbl_wrap" id="inorderlist">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_m">
            <a href="./inorderform.php?od_id=<?php echo $row['od_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03" target="_blink" rel="noreferrer noopener"><span class="sound_only"><?php echo $row['od_id']; ?> </span>보기</a>
