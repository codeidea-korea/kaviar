...
$sql_date = " and iq_time between '{$fr_date}' and '{$to_date}' ";
...
<div class="tbl_head01 tbl_wrap" id="itemqalist">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_s">
            <a href="./shop_admin/itemqaform.php?w=u&amp;iq_id=<?php echo $row['iq_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03" target="_blink" rel="noreferrer noopener"><span class="sound_only"><?php echo get_text($row['iq_subject']); ?> </span>수정</a>
        </td>
    </tr>
    <?php
    }
