...
$it_timer_start = isset($_POST['it_timer_start']) ? $_POST['it_timer_start'] : '';
...
$sql_common = " ca_id               = '$ca_id',
				...
				it_tel_inq_text		= '$it_tel_inq_text',
                it_info_gubun       = '$it_info_gubun',
                it_info_value       = '$it_info_value',
				it_info_values      = '$it_info_values',
...
$sql_common .= " , 
				...
				it_type10							= '$it_type10',
				it_timer							= '$it_timer',
				it_timer_start						= '$it_timer_start',				
				it_time_price						= '$it_time_price',
				it_type								= '$it_type',
				it_tag								= '$it_tag',
				it_grade								= '$it_grade',
				it_store_id							= '$it_store_id',
				it_shpping_name						= '$it_shpping_name',
				it_use_show							= '$it_use_show',
				it_sale_start_date					= '$it_sale_start_date',
				it_sale_end_date					= '$it_sale_end_date'
				";
