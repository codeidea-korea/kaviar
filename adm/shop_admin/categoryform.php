...
if ($w == "")
{
    ...
    else // 1단계 분류
    {
        ...
        $ca['ca_use'] = 1;
        $ca['ca_explan_html'] = 1;
        $ca['ca_img_width']  = $theme_config['ca_img_width'] ? $theme_config['ca_img_width'] : $default['de_simg_width'];
        $ca['ca_img_height'] = $theme_config['ca_img_height'] ? $theme_config['ca_img_height'] : $default['de_simg_height'];
        $ca['ca_mobile_img_width']  = $theme_config['ca_mobile_img_width'] ? $theme_config['ca_mobile_img_width'] : $default['de_simg_width'];
        $ca['ca_mobile_img_height'] = $theme_config['ca_mobile_img_height'] ? $theme_config['ca_mobile_img_height'] : $default['de_simg_height'];
		$ca['ca_list_mod'] = $theme_config['ca_list_mod'];
        $ca['ca_list_row'] = $theme_config['ca_list_row'];
        $ca['ca_mobile_list_mod'] = $theme_config['ca_mobile_list_mod'];
        $ca['ca_mobile_list_row'] = $theme_config['ca_mobile_list_row'];
        $ca['ca_stock_qty'] = 99999;
    }
    $ca['ca_skin'] = $theme_config['ca_skin'];
    $ca['ca_mobile_skin'] = $theme_config['ca_mobile_skin'];
}
else if ($w == "u")
{
    $sql = " select * from {$g5['g5_shop_category_table']} where ca_id = '$ca_id' ";
...
if(file_exists($_my_php)) { //인태 - 커스텀페이지로 대체
	require_once($_my_php);
	return;
}
?>
