...
$sql_date = " and a.is_time between '{$fr_date}' and '{$to_date}' ";
*/
//$where = " where a.wr_is_comment = 0 ";

$sql_search = " where a.is_name = '$stx' or a.mb_id = '$mb_id' ";
...
<div class="tbl_head01 tbl_wrap" id="itemuselist">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_s">
            <a href="./shop_admin/itemuseform.php?w=u&amp;is_id=<?php echo $row['is_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03" target="_blink"><span class="sound_only"><?php echo get_text($row['is_subject']); ?> </span>수정</a>
        </td>
    </tr>
