...
if($cp['it_explan']) {
    ...
    $sql = " update {$g5['g5_shop_item_table']} set it_time = '".date("Y-m-d h:i:s")."', it_explan = '".addslashes($cp['it_explan'])."' where it_id = '$new_it_id' ";
    sql_query($sql);
}
...
if($cp['it_mobile_explan']) {
    ...
    $sql = " update {$g5['g5_shop_item_table']} set it_time = '".date("Y-m-d h:i:s")."', it_mobile_explan = '".addslashes($cp['it_mobile_explan'])."' where it_id = '$new_it_id' ";
    sql_query($sql);
}
