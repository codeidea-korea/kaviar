...
if ($where) {
    $sql_search1 .= ' and '.implode(' and ', $where);
}
...
$sql_common1 = " from {$g5['g5_shop_order_table']} $sql_search1 ";

$sql = " select count(*) as cnt from ( select *, (SELECT it_id FROM g5_shop_cart WHERE g5_shop_cart.od_id = g5_shop_order.od_id AND g5_shop_cart.it_id = '1724917878' LIMIT 1) AS it_id " . $sql_common1. " )c where it_id = '1724917878' ";
...
<div class="flex flex-right mb15">
	<a href="<?=G5_ADMIN_URL?>/shop_admin/my/_excel_orderlist_view.php<?=$btn_qstr?>" class="btn_excel_download" target="_blank">엑셀 다운로드</a>
</div>
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        ...
        <td rowspan="3" class="td_mng td_mng_s">
            <a href="./orderview_form.php?od_id=<?php echo $row['od_id']; ?>&amp;<?php echo $qstr; ?>" class="mng_mod btn btn_02"><span class="sound_only"><?php echo $row['od_id']; ?> </span>보기</a>
        </td>
    </tr>
