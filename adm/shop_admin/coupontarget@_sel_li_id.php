...
<div id="sch_target_frm" class="new_win scp_new_win">
    ...
    <div class="tbl_head01 tbl_wrap new_win_con p10">
        <table>
        ...
        <tr>
            ...
            <td class="td_mng td_mng_s"><button type="button" class="btn_item_sel<?=(in_array($row['t_id'], $sel_li_id)?' active':'')?>" data-id="<?=$row['t_id']?>">선택</button>
        </tr>
        <?php
        }
...
<script>
$('.btn_item_sel').click(function() {
	$(this).toggleClass('active');
	var cardCount = 0;
	var sel_li_id = '';
	$('.btn_item_sel.active').each(function(index) {
