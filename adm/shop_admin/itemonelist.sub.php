...
$sql_date = " and wr_datetime between '{$fr_date}' and '{$to_date}' ";
*/
$sql_search = " where a.wr_is_comment = 0 and wr_del = 'N' and a.mb_id = '$mb_id' ";
...
<div class="tbl_head01 tbl_wrap" id="itemqalist">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mng td_mng_s">
            <a href="./shop_admin/itemoneform.php?w=u&amp;wr_id=<?php echo $row['wr_id']; ?>&amp;<?php echo $qstr; ?>" class="btn btn_03" target="_blink" rel="noreferrer noopener"><span class="sound_only"><?php echo get_text($row['wr_content']); ?> </span>수정</a>
        </td>
    </tr>
    <?php
    }
