...
for ($i=0; $i<$post_ca_id_count; $i++)
{
    ...
    $check_keys = array('ca_mb_id', 'ca_id', 'ca_use', 'ca_list_mod', 'ca_cert_use', 'ca_menu_use', 'ca_skin', 'ca_mobile_skin', 'ca_skin_dir', 'ca_mobile_skin_dir', 'ca_img_width', 'ca_img_height', 'ca_mobile_img_width', 'ca_mobile_img_height', 'ca_list_row', 'ca_mobile_list_mod', 'ca_mobile_list_row');
    ...
    $sql = " update {$g5['g5_shop_category_table']}
                set ca_name             = '".$p_ca_name."',
                    ...
                    ca_menu_use        = '".sql_real_escape_string(strip_tags($posts['ca_menu_use']))."',
					...
					ca_mobile_img_width        = '".sql_real_escape_string(strip_tags($posts['ca_mobile_img_width']))."',
                    ca_mobile_img_height       = '".sql_real_escape_string(strip_tags($posts['ca_mobile_img_height']))."',
