...
-->
    <div class="btn_confirm01 btn_confirm" style="display:flex;justify-content: center;align-items: center;">
        <input type="submit" value="배송정보 등록" class="btn_submit">
		&nbsp;&nbsp;&nbsp;
        <button type="button" style="border-radius:3px;height:32px" onclick="window.close();">닫기</button>
    </div>
