...
'cf_use_point',                 //포인트 사용
'de_settle_order_min_point',    //최소구매금액 포이트사용
...
'de_sms_use6',                  //SMS 회원가입시 고객님께 발송
'de_sms_use7',                  //SMS 주문시 고객님께 발송
'de_sms_use8',                  //SMS 주문시 주문시 관리자에게 발송
'de_sms_use9',                  //SMS 입금확인시 고객님께 발송
'de_sms_use10',                  //SMS 상품배송시 고객님께 발송
'de_sms_use11',                  //SMS 상품배송시 고객님께 발송
'de_sms_use12',
'de_sms_use13',
'de_sms_use14',
'de_sms_use15',
...
'de_cash_sale',					//현금할일율
'de_cash_sale_use',
'de_item_use_approval',
'de_item_use_review',
'de_item_use_review_p',
'de_popular_word',
'de_popular_1',
'de_popular_2',
'de_popular_3',
...
// 파일삭제
if ($it_img1_del) {
	$it_img1    = $default['de_item_list_top_img'];
...
if ($_FILES['it_img1']['name']) {
	...
	$imgs_explode = explode(".",$_FILES['it_img1']['name']);
	$it_imgs = $imgs_explode[0]."_".date('his').".".$imgs_explode[1];
    $it_img1 = it_img_upload($_FILES['it_img1']['tmp_name'], $it_imgs, $it_img_dir.'/'.$it_id);
}
...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
				...
				de_admin_domain				  = '{$de_admin_domain}',
				...
				de_settle_order_min_point           = '{$de_settle_order_min_point}',
				...
				de_sms_cont7                  = '{$_POST['de_sms_cont7']}',
				de_sms_cont8                  = '{$_POST['de_sms_cont8']}',
				de_sms_cont9                  = '{$_POST['de_sms_cont9']}',
				de_sms_cont10                  = '{$_POST['de_sms_cont10']}',
				de_sms_cont11                  = '{$_POST['de_sms_cont11']}',
				de_sms_cont12                  = '{$_POST['de_sms_cont12']}',
				de_sms_cont13                  = '{$_POST['de_sms_cont13']}',
				de_sms_cont14                  = '{$_POST['de_sms_cont14']}',
				de_sms_cont15                  = '{$_POST['de_sms_cont15']}',
				...
				de_sms_use11                   = '{$de_sms_use11}',
				de_sms_use12                  = '{$de_sms_use12}',
				de_sms_use13                  = '{$de_sms_use13}',
				de_sms_use14                  = '{$de_sms_use14}',
				de_sms_use15                  = '{$de_sms_use15}',
                de_sms_hp                     = '{$de_sms_hp}',
				...
				de_cash_sale				  = '{$de_cash_sale}',
				de_cash_sale_use			  = '{$de_cash_sale_use}',
				...
				de_item_use_approval		  = '{$de_item_use_approval}',
				de_item_use_review			  = '{$de_item_use_review}',
				de_item_use_review_p		  = '{$de_item_use_review_p}',
				de_item_list_top_img		  = '{$it_imgs}',
				de_popular_word				  = '{$de_popular_word}',
				de_popular_1                  = '{$de_popular_1}',
				de_popular_2                  = '{$de_popular_2}',
				de_popular_3                  = '{$de_popular_3}',
				de_popular_4                  = '{$de_popular_4}',
				de_popular_5                  = '{$de_popular_5}',
				de_popular_6                  = '{$de_popular_6}',
				de_popular_7                  = '{$de_popular_7}',
				de_popular_8                  = '{$de_popular_8}',
				de_popular_9                  = '{$de_popular_9}',
				de_popular_10                 = '{$de_popular_10}'
                ";
...
/* 인태 - 추가된 필드 */
if(file_exists('./my/configformupdate.php')) {
	include_once('./my/configformupdate.php');
}
sql_query($sql);
...
// LG, 아이코드 설정
// 2024-02-21 준섭 (cf_aligo_token_key,cf_aligo_sender 추가)
$sql = " update {$g5['config_table']}
            set cf_sms_use              = '{$cf_sms_use}',
				...
				cf_aligo_token_key		= '{$cf_aligo_token_key}',				
				cf_aligo_sender			= '{$cf_aligo_sender}',
				cf_naver_sender			= '{$cf_naver_sender}',
                cf_lg_mid               = '{$cf_lg_mid}',
