...
else
{
    ...
    $ev['ev_img_width']  = $theme_config['ev_img_width'];
    $ev['ev_img_height'] = $theme_config['ev_img_height'];
    $ev['ev_list_mod'] = $theme_config['ev_list_mod'];
    $ev['ev_list_row'] = $theme_config['ev_list_row'];
    $ev['ev_mobile_img_width']  = $theme_config['ev_mobile_img_width'];
    $ev['ev_mobile_img_height'] = $theme_config['ev_mobile_img_height'];
    $ev['ev_mobile_list_mod'] = $theme_config['ev_mobile_list_mod'];
    $ev['ev_mobile_list_row'] = $theme_config['ev_mobile_list_row'];

	$ev['ev_begin_time'] = date("Y-m-d 00:00:00", time());
    //$ev['ev_end_time']   = date("Y-m-d 00:00:00", time()+(60*60*24*31));
