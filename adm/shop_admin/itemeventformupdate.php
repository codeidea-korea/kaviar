...
$ev_banner_link = implode("|", $_POST['ev_banner_link']);
$ev_begin_time = isset($_POST['ev_begin_time']) ? clean_xss_tags($_POST['ev_begin_time'], 1, 1) : '';
$ev_end_time = isset($_POST['ev_end_time']) ? clean_xss_tags($_POST['ev_end_time'], 1, 1) : '';
...
$sql_common = " set ev_skin             = '$ev_skin',
					...
					ev_banner_link   = '$ev_banner_link',
					ev_begin_time   = '$ev_begin_time',
