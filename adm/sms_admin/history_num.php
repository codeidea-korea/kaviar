...
<div class="tbl_head01 tbl_wrap">
    ...
    $qry = sql_query("select a.*, b.mb_name, b.mb_grade from {$g5['sms5_history_table']} a, {$g5['member_table']} b where a.mb_id = b.mb_id $sql_search order by hs_no desc limit $page_start, $page_size");
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_datetime"><?php echo get_member_grade_name($res['mb_grade']) ?></td>
        <td class="td_datetime"><?php echo $res['mb_name']?></td>
        <td class="td_datetime"><?php echo $mb_id; ?></td>
        <td class="td_numbig"><?php echo $res['hs_hp']; ?></td>
        <td class="td_datetime"><?php echo date('Y-m-d H:i', strtotime($res['hs_datetime']))?></td>
        <td class="td_boolean"><?php echo $res['hs_flag']?'성공':'실패'?></td>
        <td class="td_left"><span title="<?php echo $res['hs_memo']?>"><?php echo $res['hs_memo']?></span></td>
	<!--
