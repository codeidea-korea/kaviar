...
<?php
	if ($config['cf_sms_use'] == 'aligo') { // 아이코드 사용
		$cf_sender = $config['cf_aligo_sender'];
	}else if ($config['cf_sms_use'] != 'icode') { // 아이코드 사용
		$cf_sender = $config['cf_icode_sender'];
	}
?>
...
<?php
if ($config['cf_sms_use'] == 'aligo') { // 알리고 사용
?>
<div id="sms5_send">
    ...
    <div id="send_write">
		...
		<input type="hidden" name="sms_use" value="aligo">
        ...
        <div id="write_reply">
            ...
            <input type="text" name="wr_reply" value="<?php echo isset($cf_sender) ? get_sanitize_input($cf_sender) : ''; ?>" id="wr_reply" required class="frm_input required" size="17" maxlength="20" readonly="readonly">
        </div>
...
<!--
  ...
  -->
    ...
    <div id="send_book">
        <h2>휴대폰번호 목록</h2>
        <div id="book_tab">
            <a href="#book_group" id="book_group" style="display:none" class="btn btn_02">그룹</a>
            <a href="#book_person" id="book_person" style="display:none" class="btn btn_02">개인</a>
            <a href="#book_level" id="book_level" class="btn btn_02">회원등급</a>
        </div>
...
<div id="sms5_send">
    ...
    <div id="send_write">
        <form name="form_sms" id="form_sms" method="post" action="sms_write_send.php" onsubmit="return sms5_chk_send(this);"  >
        <input type="hidden" name="send_list" value="">
		<input type="hidden" name="sms_use" value="icode">
