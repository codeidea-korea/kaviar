...
// 회원 데이터 마이그레이션
$qry = sql_query("select mb_id, mb_name, mb_grade, mb_hp, mb_sms, mb_leave_date from ".$g5['member_table']." where mb_sms = 1, and mb_hp != '' order by mb_datetime");
while ($res = sql_fetch_array($qry))
{
    ...
    $field = "mb_id='{$res['mb_id']}', mb_grade = '{$res['mb_grade']}', bk_name='".addslashes($res['mb_name'])."', bk_hp='{$hp}', bk_receipt='{$bk_receipt}', bk_datetime='".G5_TIME_YMDHIS."'";
