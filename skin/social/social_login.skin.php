...
if(file_exists(G5_THIS_PATH.'/member/social_login.skin.php')) {
	require_once(G5_THIS_PATH.'/member/social_login.skin.php');
	return;
} else if(defined('G5_THEME_PATH') && file_exists(G5_THEME_PATH.'/member/social_login.skin.php')) {
	require_once(G5_THEME_PATH.'/member/social_login.skin.php');
	return;
}
