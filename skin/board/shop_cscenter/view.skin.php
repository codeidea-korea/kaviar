...
<article id="bo_v" style="<?php if(!G5_IS_MOBILE) echo $bo_width; ?>">
	...
	<header id="bo_v_header">
        ...
        <?php if($isSubject) echo '<div id="bo_v_subject" class="fw600">'.cut_str(get_text($view['wr_subject']), 70).'</div>'; ?>
    </header>
			...
			<?
				...
				for($i=0; $i< count($files); $i++) {
					...
					$f_ex = explode('.',$files[$i]);
						...
						// 이미지 출력
						echo "<img src='".$dirfile.$files[$i]."' style='width:25%;padding-top:5px;padding-bottom:5px'><br><br>";
