	...
	<ul class="mix-ul">
		...
		<li class="mix-li">
			...
			<div class="mix-con">
				...
				<textarea name="wr<?=$i?>[1]" placeholder="보조 텍스트" class="text-sub autosize" style="min-height:100px"><?=$wr[$i][1]?></textarea>
				...
				<select name="wr_sub[<?=$i?>][2]" value="<?=$wr_sub[$i][2]?>" class="span120">
					<?php
