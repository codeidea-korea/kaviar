...
<section id="bo_w" style="<?=$bo_width?>">
    ...
    <div class="wr-wrap label120">
		...
		<?php if($wr_use || $wr_include || $wr_option) echo '<div class="wr-group">'.$wr_use.$wr_include.$wr_option.'</div>'; ?>
...
function fwrite_submit(f)
{
	...
	<?php } else { echo $editor_js; echo $editor_mobile_js;} // 에디터 사용시 자바스크립트에서 내용을 폼필드로 넣어주며 내용이 입력되었는지 검사함   ?>
