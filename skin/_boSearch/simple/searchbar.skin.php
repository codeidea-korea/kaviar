...
if($board['bo_search_color']) {
	$searchbarStyle .= '#bo_sch .seachContainer{border-color:'.$board['bo_searchbar_color'].'}';
	$searchbarStyle .= '#bo_sch .seachContainer .iconSearch{color:'.$board['bo_searchbar_color'].';}';
}
?>
