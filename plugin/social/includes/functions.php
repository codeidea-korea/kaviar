...
function social_get_data($by='provider', $provider, $user_profile){
    ...
    if( $by == 'provider' ){
		...
		//$email = (isset($user_profile->emailVerified) && $user_profile->emailVerified !== '' && $user_profile->emailVerified !== null) ? $user_profile->emailVerified : $user_profile->email;
...
function social_register_member_check($member){
    ...
    if( $user_profile = social_session_exists_check() ){
		...
		//$member['mb_email'] = (isset($user_profile->emailVerified) && $user_profile->emailVerified !== '' && $user_profile->emailVerified !== null) ? $user_profile->emailVerified : $user_profile->email;
		
		$member['mb_email'] = $user_profile->email;
