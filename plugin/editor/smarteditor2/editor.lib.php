...
function editor_html($id, $content, $is_dhtml_editor=true, $editor_height=300) //인태 - $editor_height 추가
{
    ...
    if ($is_dhtml_editor)
        //$html .= '<script>document.write("<div class=\'cke_sc\'><button type=\'button\' class=\'btn_cke_sc\'>단축키 일람</button></div>");</script>'; //인태 - 단축키 사용안함
	...
	//if(!$is_dhtml_editor) $is_editor_label = "label";
    $html .= "\n<textarea id=\"$id\" name=\"$id\" class=\"$smarteditor_class autosize ".$is_editor_label."\" maxlength=\"65536\" style=\"width:100%;min-height:{$editor_height}px\" data-label=\"내용\" placeholder=\"내용\">$content</textarea>"; //인태
