...
<li>
	<div id="sns_login_wrap" style="margin-top:0;">
		<span class="title">SNS 로그인 관리</span>
		<ul class="sns-wrap">
			<?php foreach( $socials as $social=>$provider_name ){
				...
				echo '<li><a href="'.$link_href.'" id="sns-'.$social.'" class="social_link sns-'.$social.$add_class.'" title="'.$title.'" data-provider="'.$social.'"><span class="txt">'.$provider_name.' 로그인</span></a>';
