...
<style>
/* 상품후기 폼 */
#review-form1{height:100vh;border-left:1px solid var(--outline-color);border-right:1px solid var(--outline-color);}
#review-form1 .form-head{font-size:15px;font-weight:600;position:fixed;top:0;z-index:100;width:100%;height:60px;max-width:var(--mobile-max-width);background:#fff;z-index:88;
			display:flex;align-items:center;justify-content:center;}
#review-form1 .form-head:after{content:'';position:absolute;bottom:0;left:0;width:100%;height:1px;background:rgba(0,0,0,0.1);}
#review-form1 .form-head + *{margin-top:60px;background:#fff;}		
#review-form1 .form-body{min-height:calc(100vh - 60px);display:flex;flex-direction:column;}
#review-form1 .form-body .item-subject{padding:20px;font-size:15px;font-weight:500;line-height:1.5em;}
#review-form1 .form-body .formContainer{padding:20px;gap:20px;}
#review-form1 .form-body .formContainer .label{font-size:13px;font-weight:600;color:#46433F;margin-bottom:10px;}
#review-form1 .form-body .form-btnSet{padding:20px;margin-top:auto;}
</style>
<div id="review-form1" class="_modal_popup">
	...
	<div class="form-body">	
		...
		<ul class="formContainer">
			<li>
				...
				<input type="text" name="is_subject" value="<?php echo get_text($use['is_subject']); ?>" id="is_subject" required class="required w-full" minlength="2" maxlength="250" placeholder="제목을 입력해 주세요">
			</li>
		...
		<div class="px20">
			<div class="fs16 bold">사진/영상업로드</div>
