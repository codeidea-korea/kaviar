...
<section id="_itemsSort">
	<select class="select-link selectpicker">
		...
		<option value="<?=$sct_sort_href?>it_update_time&amp;sortodr=desc"<?=$sort=='it_update_time'?' selected':''?>>신상품순</option>
		<option value="<?=$sct_sort_href?>it_sum_qty&amp;sortodr=desc"<?=$sort=='it_sum_qty'?' selected':''?>>판매량순</option>
