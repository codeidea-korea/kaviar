...
// 황팀 - 추가 ──────────────
$is_back = true; //뒤로가기
$head_title = $default['shop_use_closure'] && !$member['mb_id'] ? '<span class="it_name_hide"></span>' : $it['it_name'];
// ──────────────────────
include_once(G5_MSHOP_PATH.'/_head.php');
include_once(G5_SHOP_PATH.'/settle_naverpay.inc.php');

// 상단 HTML
echo '<div id="sit_hhtml" class="">'.conv_content($it['it_mobile_head_html'], 1).'</div>';
?>

<?php if($is_orderable) { ?>
<script src="<?=get_url( G5_JS_URL.'/shop.js')?>"></script>
<?php } ?>
