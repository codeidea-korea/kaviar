...
echo '<div id="_event_list">';
	if($is_admin) echo '<a href="'.G5_ADMIN_URL.'/shop_admin/itemevent.php" class="btnSetting _blank" target="_blank" data-area="#_event_list">이벤트 관리</a>';
	echo '<ul id="_event_main_ul" class="p20">';
		for ($i=0; $row=sql_fetch_array($result); $i++) {	
			...
			echo '<li><a href="'.shop_short_url_my('event', $row['ev_id']).'">'.$list_str.'</a></li>';
		}
	echo '</ul>';
echo '</div>';
