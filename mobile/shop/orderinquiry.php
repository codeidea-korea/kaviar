...
$no_list_msg = $default['shop_type'] ? '예약이 존재하지 않습니다.' : '주문이 존재하지 않습니다.';
...
$g5['title'] = $default['shop_type'] ? '예약조회' : '주문내역조회';

$topMenu_skip = true;
$head_title = $default['shop_type'] ? '최근예약내역' : '최근주문내역';
