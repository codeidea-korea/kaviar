...
if(defined('G5_THEME_MSHOP_PATH')) {
    $theme_wishlist_file = file_exists(G5_THEME_MSHOP_PATH.'/wishlist.php') ? G5_THEME_MSHOP_PATH.'/wishlist.php' : G5_THEME_SHOP_PATH.'/wishlist.php';
...
<div id="sod_ws">
    ...
    <div id="sod_ws_act">
        <button type="submit" class="_btn/lg/rd5 flex1" onclick="return fwishlist_check(document.fwishlist,'direct_buy');">바로구매</button>
        <button type="submit" class="_btn/lg/rd5/line/mainColor flex1 btnCart" onclick="return fwishlist_check(document.fwishlist,'');">장바구니</button>
    </div>
    </form>
</div>
